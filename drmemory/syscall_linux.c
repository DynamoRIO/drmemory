...
syscall_info_t syscall_info[] = {
    ...
    {65,"getpgrp", OK, 0,},
    {66,"setsid", OK, 0,},
    {67,"sigaction", OK, 3,/*FIXME type: {{1,sizeof(struct old_sigaction),W},{2,sizeof(struct old_sigaction),R},}*/},
    {68,"sgetmask", OK, 0,},
    {69,"ssetmask", OK, 1,},
    {70,"setreuid16", OK, 2,},
    {71,"setregid16", OK, 2,},
    {72,"sigsuspend", OK, 3,},
    {73,"sigpending", OK, 1,/*FIXME type: {{0,sizeof(old_sigset_t),W},}*/},
    {74,"sethostname", OK, 2,{{0,-1,R},}},
    {75,"setrlimit", OK, 2,{{1,sizeof(struct rlimit),R},}},
    {76,"old_getrlimit", OK, 2,{{1,sizeof(struct rlimit),W},}},
    {77,"getrusage", OK, 2,{{1,sizeof(struct rusage),W},}},
    {78,"gettimeofday", OK, 2,{{0,sizeof(struct timeval),W},{1,sizeof(struct timezone),W},}},
    {79,"settimeofday", OK, 2,{{0,sizeof(struct timeval),R},{1,sizeof(struct timezone),R},}},
    ...
    {118,"fsync", OK, 1,},
    {119,"sigreturn", OK, 0},
    {120,"clone", OK, 2,}, /* 3 params added in later kernels special-cased */
    {121,"setdomainname", OK, 2,{{0,-1,R},}},
    {122,"newuname", OK, 1,{{0,sizeof(struct new_utsname),W},}},
    {123,"modify_ldt", OK, 3, /* FIXME: ***Missing prototype*** */ },
    {124,"adjtimex", OK, 1,{{0,sizeof(struct timex),R},}},
    {125,"mprotect", OK, 3,},
    ...
    {134,"bdflush", OK, 2,},
    {135,"sysfs", OK, 3,},
    {136,"personality", OK, 1,},
    {137,"ni_syscall", OK, 0,},
    {138,"setfsuid16", OK, 1,},
    {139,"setfsgid16", OK, 1,},
    {140,"llseek", OK, 5,{{3,sizeof(loff_t),W},}},
    {141,"getdents", OK, 3,{{1,-2,W},{1,RET,W},}},
    /* FIXME: process manually below here */
    {142,"select", OK, 5,/* special-cased below */},
    {143,"flock", OK, 2,},
    {144,"msync", OK, 3,{{0,-1,R},}},
    {145,"readv", OK, 3, /* FIXME 1,ARG3 * sizeof(struct vki_iovec),R, 1,****** special-case:  (Addr)vec[i].iov_base, nReadThisBuf,R, */},
    {146,"writev", OK, 3, /* FIXME 1,ARG3 * sizeof(struct vki_iovec),R, 1,****** special-case:  "writev(vector[...])", OK, (Addr)vec[i].iov_base, vec[i].iov_len,R, */},
    {147,"getsid", OK, 1,},
    {148,"fdatasync", OK, 1,},
    {149,"sysctl", OK, 1,{{0,sizeof(struct __sysctl_args),R},}},/*special-cased*/
    {150,"mlock", OK, 2,},
    {151,"munlock", OK, 2,},
    {152,"mlockall", OK, 1,},
    {153,"munlockall", OK, 0,},
    {154,"sched_setparam", OK, 2,{{1,sizeof(struct sched_param),R},}},
    {155,"sched_getparam", OK, 2,{{1,sizeof(struct sched_param),W},}},
    {156,"sched_setscheduler", OK, 3,{{2,sizeof(struct sched_param),R},}},
    {157,"sched_getscheduler", OK, 1,},
    {158,"sched_yield", OK, 0,},
    {159,"sched_get_priority_max", OK, 1,},
    {160,"sched_get_priority_min", OK, 1,},
    {161,"sched_rr_get_interval", OK, 2, /* FIXME  1,sizeof(struct timespec),U, */},
    {162,"nanosleep", OK, 2,{{0,sizeof(struct timespec),R},{1,sizeof(struct timespec),W},}},
    {163,"mremap", OK, 4,}, /* 5th arg is conditional so special-cased below */
    {164,"setresuid16", OK, 3,},
    {165,"getresuid16", OK, 3,/*FIXME type: {{0,sizeof(old_uid_t),W},{1,sizeof(old_uid_t),W},{2,sizeof(old_uid_t),W},}*/},
    {166,"vm86", OK, 2, /* FIXME: ***Missing prototype*** */ },
    {167,"ni_syscall", OK, 0,},
    {168,"poll", OK, 3, /* special-cased below */},
    {169,"nfsservctl", OK, 3, /* FIXME 1,sizeof(struct nfsctl_arg),U, 2,sizeof(void),U, */},
    {170,"setresgid16", OK, 3,},
    {171,"getresgid16", OK, 3,/*FIXME type: {{0,sizeof(old_gid_t),W},{1,sizeof(old_gid_t),W},{2,sizeof(old_gid_t),W},}*/},
    {172,"prctl", OK, 1, /* special-cased below */},
    {173,"rt_sigreturn", OK, 0},
    {174,"rt_sigaction", OK, 4,/*1 is special-cased below*/{{2,sizeof(kernel_sigaction_t),W},}},
    {175,"rt_sigprocmask", OK, 4,{{1,sizeof(kernel_sigset_t),R},{2,sizeof(kernel_sigset_t),W},}},
    {176,"rt_sigpending", OK, 2,{{0,sizeof(kernel_sigset_t),W},}},
    {177,"rt_sigtimedwait", OK, 4,{{0,sizeof(kernel_sigset_t),R},{1,sizeof(siginfo_t),W},{2,sizeof(struct timespec),R},}},
    {178,"rt_sigqueueinfo", OK, 3,{{2,sizeof(siginfo_t),R},}},
    {179,"rt_sigsuspend", OK, 2, /* FIXME 0,sizeof(siginfo_t),R, 0,****** special-case:  arg2, sizeof(struct vki_msqid64_ds),R, */},
/* WARNING: pread64 4 != 5 */
...
/* WARNING: pwrite64 4 != 5 */
    ...
    {186,"sigaltstack", OK, 2, /* FIXME 0,****** special-case:  "sigaltstack(ss)", OK, (Addr)&ss->ss_sp, sizeof(ss->ss_sp),R, 0,****** special-case:  "sigaltstack(ss)", OK, (Addr)&ss->ss_size, sizeof(ss->ss_size),R,{1,sizeof(cap_user_data_t data),W}, */},
    {187,"sendfile", OK, 4,{{2,sizeof(off_t),W},}},
    {188,"ni_syscall", OK, 0,},
    {189,"ni_syscall", OK, 0,},
    {190,"vfork", OK, 0,},
...
/* WARNING: ftruncate64 2 != 3 */
    ...
    {203,"setreuid", OK, 2,},
    {204,"setregid", OK, 2,},
    {205,"getgroups", OK, 2,/*FIXME{{1,ARG1 * sizeof(vki_gid_t),W},{1,RES * sizeof(vki_gid_t),W},}*/},
    {206,"setgroups", OK, 2,/*FIXME{{1,ARG1 * sizeof(vki_gid_t),R},}*/},
    {207,"fchown", OK, 3,},
    {208,"setresuid", OK, 3,},
    ...
    {215,"setfsuid", OK, 1,},
    {216,"setfsgid", OK, 1,},
    {217,"pivot_root", OK, 2, /* FIXME 0,sizeof(char),U, 1,sizeof(char),U, */},
    {218,"mincore", OK, 3,{{2,/*FIXME: round up to next page size*/-1,W},}},
    {219,"madvise", OK, 3,},
    {220,"getdents64", OK, 3,{{1,-2,W},{1,RET,W},}},
    {221,"fcntl64", OK, 2,}, /*special-cased: 3rd arg not always required*/
    {222,"ni_syscall", OK, 0,},
    {223,"ni_syscall", OK, 0,},
    {224,"gettid", OK, 0,},
    {225,"readahead", OK, 3,},
    ...
    {241,"sched_setaffinity", OK, 3,{{2,-1,R},}},
    {242,"sched_getaffinity", OK, 3,{{2,-1,W},}},
    {243,"set_thread_area", OK, /* FIXME: ***Missing prototype*** */ },
    {244,"get_thread_area", OK, /* FIXME: ***Missing prototype*** */ },
    {245,"io_setup", OK, 2,/*FIXME type: {{1,sizeof(aio_context_t),W},}*/},
    {246,"io_destroy", OK, 1,},
    {247,"io_getevents", OK, 5, /* FIXME 3,sizeof(struct io_event),W, 3,****** special-case:  cb->aio_buf, vev->result,W,{4,sizeof(struct timespec),R}, */},
    {248,"io_submit", OK, 3, /* FIXME 2,ARG2*sizeof(struct vki_iocb *),R, 2,****** special-case:  "io_submit(PWRITE)", OK, cb->aio_buf, cb->aio_nbytes,R, */},
    {249,"io_cancel", OK, 3,/* FIXME type: {{1,sizeof(struct iocb),R},{2,sizeof(struct io_event),W},}*/},
/* WARNING: fadvise64 4 != 5 */
    {250,"fadvise64", OK, 4,},
    {251,"ni_syscall", OK, 0,},
    {252,"exit_group", OK, 1,},
/* WARNING: lookup_dcookie 3 != 4 */
    {253,"lookup_dcookie", OK, 3, /* FIXME 1,sizeof(char),U,{2,-3,W},{2,RET,W}, */},
    {254,"epoll_create", OK, 1,},
    {255,"epoll_ctl", OK, 4,{{3,sizeof(struct epoll_event),R},}},
    {256,"epoll_wait", OK, 4,{{1,sizeof(struct epoll_event),W},/*FIXME {1,sizeof(struct vki_epoll_event)*RES,W},*/}},
    {257,"remap_file_pages", OK, 5,},
    {258,"set_tid_address", OK, 1, /* FIXME 0,sizeof(int),U, */},
    {259,"timer_create", OK, 3,{{1,sizeof(struct sigevent),R},{2,sizeof(timer_t),W},}},
    {260,"timer_settime", OK, 4,{{2,sizeof(struct itimerspec),R},{3,sizeof(struct itimerspec),W},}},
    {261,"timer_gettime", OK, 2,{{1,sizeof(struct itimerspec),W},}},
    {262,"timer_getoverrun", OK, 1,},
    {263,"timer_delete", OK, 1,},
    {264,"clock_settime", OK, 2,{{1,sizeof(struct timespec),R},}},
...
/* WARNING: fadvise64_64 4 != 6 */
    ...
    {273,"ni_syscall", OK, 0,},
    {274,"mbind", OK, 6, /*FIXME {{3,VG_ROUNDUP(ARG5,sizeof(UWord))/sizeof(UWord),R,},}*/},
    ...
    {282,"mq_getsetattr", OK, 3, /* FIXME 1,****** special-case:  "mq_getsetattr(mqstat->mq_flags)", OK, (Addr)&attr->mq_flags, sizeof(attr->mq_flags),R,{2,sizeof(struct mq_attr),W}, */},
...
/* WARNING: unlinkat 3 != 2 */
    ...
    {310,"unshare", OK, 1,},
    {311,"set_robust_list", OK, 2,{{0,-1,R},}},
    {312,"get_robust_list", OK, 3,/*FIXME type: {{1,sizeof(struct robust_list_head),W},{2,sizeof(size_t),W},}*/},
    {313,"splice", OK, 6, /* FIXME 1,sizeof(loff_t),U, 3,sizeof(loff_t),U, */},
    {314,"sync_file_range", OK, 4,},
    {315,"tee", OK, 4,},
    {316,"vmsplice", OK, 4, /* FIXME 1,sizeof(struct iovec),U, */},
...
/* WARNING: timerfd_create 2 != 3 */
    ...
    {323,"eventfd", OK, 1,},
    {324,"fallocate", OK, 4,},
    {325,"timerfd_settime", OK, 4,{{2,sizeof(struct itimerspec),R},{3,sizeof(struct itimerspec),W},}},
    {326,"timerfd_gettime", OK, 2,{{1,sizeof(struct itimerspec),W},}},
    {327,"signalfd4", OK, 4, /* FIXME 1,sizeof(kernel_sigset_t),U, */},
    {328,"eventfd2", OK, 2,},
    {329,"epoll_create1", OK, 1,},
    {330,"dup3", OK, 3,},
