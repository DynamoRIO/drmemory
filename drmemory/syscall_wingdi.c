...
syscall_info_t syscall_user32_info[] = {
    ...
    {0,"NtUserCreateWindowEx", OK|SYSINFO_CREATE_HANDLE|SYSINFO_RET_ZERO_FAIL, 60, {{1,sizeof(LARGE_STRING),R|CT,SYSARG_TYPE_LARGE_STRING}, {2,sizeof(LARGE_STRING),R|CT,SYSARG_TYPE_LARGE_STRING}, {3,sizeof(LARGE_STRING),R|CT,SYSARG_TYPE_LARGE_STRING}, }},
...
syscall_info_t syscall_gdi32_info[] = {
    ...
    {0,"NtGdiGetObjectBitmapHandle", OK|SYSINFO_RET_ZERO_FAIL, 8, {{1,sizeof(UINT),W,}, }},
