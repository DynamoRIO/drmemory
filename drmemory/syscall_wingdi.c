...
syscall_info_t syscall_user32_info[] = {
    ...
    {0,"NtUserCreateAcceleratorTable", OK|SYSINFO_CREATE_HANDLE|SYSINFO_RET_ZERO_FAIL, 2, {{0,-1,R|SYSARG_SIZE_IN_ELEMENTS,sizeof(ACCEL)}, }},
    ...
    {0,"NtUserDestroyAcceleratorTable", OK|SYSINFO_DELETE_HANDLE, 1, },
    {0,"NtUserDestroyCursor", OK|SYSINFO_DELETE_HANDLE, 2, },
    {0,"NtUserDestroyInputContext", OK|SYSINFO_DELETE_HANDLE|SYSINFO_IMM32_DLL, 1, },
    {0,"NtUserDestroyMenu", OK|SYSINFO_DELETE_HANDLE, 1, },
    {0,"NtUserDestroyWindow", OK|SYSINFO_DELETE_HANDLE, 1, },
