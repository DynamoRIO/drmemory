...
static syscall_info_t syscall_ntdll_info[] = {
    ...
    {0,"NtEnumerateBootEntries", UNKNOWN, 2, },
    {0,"NtEnumerateDriverEntries", UNKNOWN, 2, },
    {0,"NtEnumerateKey", OK, 6, {{3,-4,W}, {3,-5,WI}, {5,sizeof(ULONG),W}, }},
    {0,"NtEnumerateSystemEnvironmentValuesEx", UNKNOWN, 3, },
    ...
    {0,"NtQueryBootEntryOrder", UNKNOWN, 2, },
    {0,"NtQueryBootOptions", UNKNOWN, 2, },
    ...
    {0,"NtQueryDriverEntryOrder", UNKNOWN, 2, },
    ...
    {0,"NtQuerySystemEnvironmentValueEx", UNKNOWN, 5, },
    ...
    {0,"NtSetBootEntryOrder", UNKNOWN, 2, },
