...
static syscall_info_t syscall_ntdll_info[] = {
    ...
    {{0,0},"NtAcceptConnectPort", OK|SYSINFO_CREATE_HANDLE, RNTST, 6, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {2,sizeof(PORT_MESSAGE),R|CT,SYSARG_TYPE_PORT_MESSAGE}, {3,0,IB}, {4,sizeof(PORT_VIEW),R|W}, {5,sizeof(REMOTE_PORT_VIEW),R|W}, }},
    ...
    {{0,0},"NtAdjustGroupsToken", OK, RNTST, 6, {{1,0,IB}, {2,sizeof(TOKEN_GROUPS),R}, {4,-3,W}, {4,-5,WI}, {5,sizeof(ULONG),W}, }},
    {{0,0},"NtAdjustPrivilegesToken", OK, RNTST, 6, {{1,0,IB}, {2,sizeof(TOKEN_PRIVILEGES),R}, {4,-3,W}, {4,-5,WI}, {5,sizeof(ULONG),W}, }},
    ...
    {{0,0},"NtClose", OK|SYSINFO_DELETE_HANDLE, RNTST, 1, {{0,}, }},
    {{0,0},"NtCloseObjectAuditAlarm", OK, RNTST, 3, {{0,sizeof(UNICODE_STRING),R|CT,SYSARG_TYPE_UNICODE_STRING}, {2,0,IB}, }},
     ...
     */
    {{0,0},"NtConnectPort", OK|SYSINFO_CREATE_HANDLE, RNTST, 8, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {1,sizeof(UNICODE_STRING),R|CT,SYSARG_TYPE_UNICODE_STRING}, {2,sizeof(SECURITY_QUALITY_OF_SERVICE),R|CT,SYSARG_TYPE_SECURITY_QOS}, {3,sizeof(PORT_VIEW),R|W}, {4,sizeof(REMOTE_PORT_VIEW),W}, {5,sizeof(ULONG),W}, {6,-7,R|WI}, {7,sizeof(ULONG),R|W}, }},
    {{0,0},"NtContinue", OK, RNTST, 2, {{0,sizeof(CONTEXT),R|CT,SYSARG_TYPE_CONTEXT}, {1,0,IB}, }},
    {{0,0},"NtCreateChannel", OK|SYSINFO_CREATE_HANDLE, RNTST, 2, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {1,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, }},
    {{0,0},"NtCreateDebugObject", OK|SYSINFO_CREATE_HANDLE, RNTST, 4, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {2,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, {3,0,IB}, }},
    {{0,0},"NtCreateDirectoryObject", OK|SYSINFO_CREATE_HANDLE, RNTST, 3, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {2,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, }},
    {{0,0},"NtCreateEvent", OK|SYSINFO_CREATE_HANDLE, RNTST, 5, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {2,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, {4,0,IB}, }},
    {{0,0},"NtCreateEventPair", OK|SYSINFO_CREATE_HANDLE, RNTST, 3, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {2,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, }},
    {{0,0},"NtCreateFile", OK|SYSINFO_CREATE_HANDLE, RNTST, 11, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {2,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, {3,sizeof(IO_STATUS_BLOCK),W}, {4,sizeof(LARGE_INTEGER),R}, }},
    {{0,0},"NtCreateIoCompletion", OK|SYSINFO_CREATE_HANDLE, RNTST, 4, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {2,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, }},
    {{0,0},"NtCreateJobObject", OK|SYSINFO_CREATE_HANDLE, RNTST, 3, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {2,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, }},
    {{0,0},"NtCreateJobSet", OK, RNTST, 3, {{1,sizeof(JOB_SET_ARRAY),R}, }},
    {{0,0},"NtCreateKey", OK|SYSINFO_CREATE_HANDLE, RNTST, 7, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {2,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, {4,sizeof(UNICODE_STRING),R|CT,SYSARG_TYPE_UNICODE_STRING}, {6,sizeof(ULONG),W}, }},
    {{0,0},"NtCreateKeyedEvent", OK|SYSINFO_CREATE_HANDLE, RNTST, 4, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {2,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, }},
    {{0,0},"NtCreateMailslotFile", OK|SYSINFO_CREATE_HANDLE, RNTST, 8, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {2,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, {3,sizeof(IO_STATUS_BLOCK),W}, {7,sizeof(LARGE_INTEGER),R}, }},
    {{0,0},"NtCreateMutant", OK|SYSINFO_CREATE_HANDLE, RNTST, 4, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {2,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, {3,0,IB}, }},
    {{0,0},"NtCreateNamedPipeFile", OK|SYSINFO_CREATE_HANDLE, RNTST, 14, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {2,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, {3,sizeof(IO_STATUS_BLOCK),W}, {7,0,IB}, {8,0,IB}, {9,0,IB}, {13,sizeof(LARGE_INTEGER),R}, }},
    ...
    {{0,0},"NtCreatePort", OK|SYSINFO_CREATE_HANDLE, RNTST, 5, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {1,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, }},
    {{0,0},"NtCreateProcess", OK|SYSINFO_CREATE_HANDLE, RNTST, 8, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {2,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, {4,0,IB}, }},
    {{0,0},"NtCreateProcessEx", OK|SYSINFO_CREATE_HANDLE, RNTST, 9, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {2,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, }},
    {{0,0},"NtCreateProfile", OK|SYSINFO_CREATE_HANDLE, RNTST, 9, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {5,sizeof(ULONG),R}, }},
    {{0,0},"NtCreateSection", OK|SYSINFO_CREATE_HANDLE, RNTST, 7, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {2,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, {3,sizeof(LARGE_INTEGER),R}, }},
    {{0,0},"NtCreateSemaphore", OK|SYSINFO_CREATE_HANDLE, RNTST, 5, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {2,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, }},
    {{0,0},"NtCreateSymbolicLinkObject", OK|SYSINFO_CREATE_HANDLE, RNTST, 4, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {2,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, {3,sizeof(UNICODE_STRING),R|CT,SYSARG_TYPE_UNICODE_STRING}, }},
    {{0,0},"NtCreateThread", OK|SYSINFO_CREATE_HANDLE, RNTST, 8, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {2,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, {4,sizeof(CLIENT_ID),W}, {5,sizeof(CONTEXT),R|CT,SYSARG_TYPE_CONTEXT}, {6,sizeof(USER_STACK),R}, {7,0,IB}, }, &sysnum_CreateThread},
    {{0,0},"NtCreateThreadEx", OK|SYSINFO_CREATE_HANDLE, RNTST, 11, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {2,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, 6,0,IB /*rest handled manually*/, }, &sysnum_CreateThreadEx},
    {{0,0},"NtCreateTimer", OK|SYSINFO_CREATE_HANDLE, RNTST, 4, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {2,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, }},
    {{0,0},"NtCreateToken", OK|SYSINFO_CREATE_HANDLE, RNTST, 13, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {2,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, {4,sizeof(LUID),R}, {5,sizeof(LARGE_INTEGER),R}, {6,sizeof(TOKEN_USER),R}, {7,sizeof(TOKEN_GROUPS),R}, {8,sizeof(TOKEN_PRIVILEGES),R}, {9,sizeof(TOKEN_OWNER),R}, {10,sizeof(TOKEN_PRIMARY_GROUP),R}, {11,sizeof(TOKEN_DEFAULT_DACL),R}, {12,sizeof(TOKEN_SOURCE),R}, }},
    ...
    {{0,0},"NtCreateWaitablePort", OK|SYSINFO_CREATE_HANDLE, RNTST, 5, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {1,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, }},
    {{0,0},"NtDebugActiveProcess", OK, RNTST, 2, },
    {{0,0},"NtDebugContinue", OK, RNTST, 3, {{1,sizeof(CLIENT_ID),R}, }},
    {{0,0},"NtDelayExecution", OK, RNTST, 2, {{0,0,IB}, {1,sizeof(LARGE_INTEGER),R}, }},
    ...
    {{0,0},"NtDeleteObjectAuditAlarm", OK, RNTST, 3, {{0,sizeof(UNICODE_STRING),R|CT,SYSARG_TYPE_UNICODE_STRING}, {2,0,IB}, }},
    ...
    {{0,0},"NtDuplicateObject", OK|SYSINFO_CREATE_HANDLE, RNTST, 7, {{3,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, }},
    {{0,0},"NtDuplicateToken", OK|SYSINFO_CREATE_HANDLE, RNTST, 6, {{2,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, {3,0,IB}, {5,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, }},
    ...
    {{0,0},"NtFilterToken", OK|SYSINFO_CREATE_HANDLE, RNTST, 6, {{2,sizeof(TOKEN_GROUPS),R}, {3,sizeof(TOKEN_PRIVILEGES),R}, {4,sizeof(TOKEN_GROUPS),R}, {5,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, }},
    ...
    {{0,0},"NtInitializeRegistry", OK, RNTST, 1, {{0,0,IB}, }},
    {{0,0},"NtInitiatePowerAction", OK, RNTST, 4, {{3,0,IB}, }},
    ...
    {{0,0},"NtLockFile", OK, RNTST, 10, {{4,sizeof(IO_STATUS_BLOCK),W}, {5,sizeof(ULARGE_INTEGER),R}, {6,sizeof(ULARGE_INTEGER),R}, {8,0,IB}, {9,0,IB}, }},
    ...
    {{0,0},"NtNotifyChangeDirectoryFile", OK, RNTST, 9, {{4,sizeof(IO_STATUS_BLOCK),W}, {5,sizeof(FILE_NOTIFY_INFORMATION),W}, {8,0,IB}, }},
    {{0,0},"NtNotifyChangeKey", OK, RNTST, 10, {{4,sizeof(IO_STATUS_BLOCK),W}, {6,0,IB}, {9,0,IB}, }},
    {{0,0},"NtNotifyChangeMultipleKeys", OK, RNTST, 12, {{2,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, {6,sizeof(IO_STATUS_BLOCK),W}, {8,0,IB}, {11,0,IB}, }},
    {{0,0},"NtOpenChannel", OK|SYSINFO_CREATE_HANDLE, RNTST, 2, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {1,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, }},
    {{0,0},"NtOpenDirectoryObject", OK|SYSINFO_CREATE_HANDLE, RNTST, 3, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {2,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, }},
    {{0,0},"NtOpenEvent", OK|SYSINFO_CREATE_HANDLE, RNTST, 3, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {2,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, }},
    {{0,0},"NtOpenEventPair", OK|SYSINFO_CREATE_HANDLE, RNTST, 3, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {2,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, }},
    {{0,0},"NtOpenFile", OK|SYSINFO_CREATE_HANDLE, RNTST, 6, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {2,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, {3,sizeof(IO_STATUS_BLOCK),W}, }},
    {{0,0},"NtOpenIoCompletion", OK|SYSINFO_CREATE_HANDLE, RNTST, 3, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {2,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, }},
    {{0,0},"NtOpenJobObject", OK|SYSINFO_CREATE_HANDLE, RNTST, 3, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {2,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, }},
    {{0,0},"NtOpenKey", OK|SYSINFO_CREATE_HANDLE, RNTST, 3, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {2,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, }},
    {{0,0},"NtOpenKeyEx", OK|SYSINFO_CREATE_HANDLE, RNTST, 4, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {2,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, }},
    {{0,0},"NtOpenKeyedEvent", OK|SYSINFO_CREATE_HANDLE, RNTST, 3, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {2,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, }},
    {{0,0},"NtOpenMutant", OK|SYSINFO_CREATE_HANDLE, RNTST, 3, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {2,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, }},
    ...
    {{0,0},"NtOpenProcess", OK|SYSINFO_CREATE_HANDLE, RNTST, 4, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {2,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, {3,sizeof(CLIENT_ID),R}, }},
    {{0,0},"NtOpenProcessToken", OK|SYSINFO_CREATE_HANDLE, RNTST, 3, {{2,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, }},
    {{0,0},"NtOpenProcessTokenEx", OK|SYSINFO_CREATE_HANDLE, RNTST, 4, {{3,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, }},
    {{0,0},"NtOpenSection", OK|SYSINFO_CREATE_HANDLE, RNTST, 3, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {2,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, }},
    {{0,0},"NtOpenSemaphore", OK|SYSINFO_CREATE_HANDLE, RNTST, 3, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {2,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, }},
    {{0,0},"NtOpenSymbolicLinkObject", OK|SYSINFO_CREATE_HANDLE, RNTST, 3, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {2,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, }},
    {{0,0},"NtOpenThread", OK|SYSINFO_CREATE_HANDLE, RNTST, 4, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {2,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, {3,sizeof(CLIENT_ID),R}, }},
    {{0,0},"NtOpenThreadToken", OK|SYSINFO_CREATE_HANDLE, RNTST, 4, {{2,0,IB}, {3,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, }},
    {{0,0},"NtOpenThreadTokenEx", OK|SYSINFO_CREATE_HANDLE, RNTST, 5, {{2,0,IB}, {4,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, }},
    {{0,0},"NtOpenTimer", OK|SYSINFO_CREATE_HANDLE, RNTST, 3, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {2,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, }},
    ...
    {{0,0},"NtPrivilegedServiceAuditAlarm", OK, RNTST, 5, {{0,sizeof(UNICODE_STRING),R|CT,SYSARG_TYPE_UNICODE_STRING}, {1,sizeof(UNICODE_STRING),R|CT,SYSARG_TYPE_UNICODE_STRING}, {3,sizeof(PRIVILEGE_SET),R}, {4,0,IB}, }},
    {{0,0},"NtPrivilegeObjectAuditAlarm", OK, RNTST, 6, {{0,sizeof(UNICODE_STRING),R|CT,SYSARG_TYPE_UNICODE_STRING}, {4,sizeof(PRIVILEGE_SET),R}, {5,0,IB}, }},
    ...
    {{0,0},"NtQueryDefaultLocale", OK, RNTST, 2, {{0,0,IB}, {1,sizeof(LCID),W}, }},
    {{0,0},"NtQueryDefaultUILanguage", OK, RNTST, 1, {{0,sizeof(LANGID),W}, }},
    {{0,0},"NtQueryDirectoryFile", OK, RNTST, 11, {{4,sizeof(IO_STATUS_BLOCK),W}, {5,-6,W}, {8,0,IB}, {9,sizeof(UNICODE_STRING),R|CT,SYSARG_TYPE_UNICODE_STRING}, {10,0,IB}, }},
    {{0,0},"NtQueryDirectoryObject", OK, RNTST, 7, {{1,-2,W}, {1,-6,WI}, {3,0,IB}, {4,0,IB}, {5,sizeof(ULONG),R|W}, {6,sizeof(ULONG),W}, }},
    {{0,0},"NtQueryDriverEntryOrder", UNKNOWN, RNTST, 2, },
    {{0,0},"NtQueryEaFile", OK, RNTST, 9, {{1,sizeof(IO_STATUS_BLOCK),W}, {2,sizeof(FILE_FULL_EA_INFORMATION),W}, {4,0,IB}, {5,sizeof(FILE_GET_EA_INFORMATION),R}, {7,sizeof(ULONG),R}, {8,0,IB}, }},
    ...
    {{0,0},"NtQueryOleDirectoryFile", OK, RNTST, 11, {{4,sizeof(IO_STATUS_BLOCK),W}, {5,-6,W}, {8,0,IB}, {9,sizeof(UNICODE_STRING),R|CT,SYSARG_TYPE_UNICODE_STRING}, {10,0,IB}, }},
    ...
    {{0,0},"NtQueryQuotaInformationFile", OK, RNTST, 9, {{1,sizeof(IO_STATUS_BLOCK),W}, {2,sizeof(FILE_USER_QUOTA_INFORMATION),W}, {4,0,IB}, {5,sizeof(FILE_QUOTA_LIST_INFORMATION),R}, {7,sizeof(SID),R}, {8,0,IB}, }},
    ...
    {{0,0},"NtRaiseException", OK, RNTST, 3, {{0,sizeof(EXCEPTION_RECORD),R|CT,SYSARG_TYPE_EXCEPTION_RECORD}, {1,sizeof(CONTEXT),R|CT,SYSARG_TYPE_CONTEXT}, {2,0,IB}, }},
    ...
    {{0,0},"NtReleaseKeyedEvent", OK, RNTST, 4, {{2,0,IB}, {3,sizeof(LARGE_INTEGER),R}, }},
    ...
    {{0,0},"NtSecureConnectPort", OK|SYSINFO_CREATE_HANDLE, RNTST, 9, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {1,sizeof(UNICODE_STRING),R|CT,SYSARG_TYPE_UNICODE_STRING}, {2,sizeof(SECURITY_QUALITY_OF_SERVICE),R|CT,SYSARG_TYPE_SECURITY_QOS}, {3,sizeof(PORT_VIEW),R|W}, {4,sizeof(SID),R}, {5,sizeof(REMOTE_PORT_VIEW),R|W}, {6,sizeof(ULONG),W}, {7,-8,R|WI}, {8,sizeof(ULONG),R|W}, }},
    ...
    {{0,0},"NtSetDebugFilterState", OK, RNTST, 3, {{2,0,IB}, }},
    {{0,0},"NtSetDefaultHardErrorPort", OK, RNTST, 1, },
    {{0,0},"NtSetDefaultLocale", OK, RNTST, 2, {{0,0,IB}, }},
    ...
    {{0,0},"NtSetTimer", OK, RNTST, 7, {{1,sizeof(LARGE_INTEGER),R}, {4,0,IB}, {6,sizeof(BOOLEAN),W}, }},
    {{0,0},"NtSetTimerResolution", OK, RNTST, 3, {{1,0,IB}, {2,sizeof(ULONG),W}, }},
    ...
    {{0,0},"NtSignalAndWaitForSingleObject", OK, RNTST, 4, {{2,0,IB}, {3,sizeof(LARGE_INTEGER),R}, }},
    ...
    {{0,0},"NtUnloadKey2", OK, RNTST, 2, {{0,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, {1,0,IB}, }},
    ...
    {{0,0},"NtWaitForDebugEvent", OK, RNTST, 4, {{1,0,IB}, {2,sizeof(LARGE_INTEGER),R}, {3,sizeof(DBGUI_WAIT_STATE_CHANGE),W}, }},
    {{0,0},"NtWaitForKeyedEvent", OK, RNTST, 4, {{2,0,IB}, {3,sizeof(LARGE_INTEGER),R}, }},
    {{0,0},"NtWaitForMultipleObjects", OK, RNTST, 5, {{1,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_READ}, {3,0,IB}, {4,sizeof(LARGE_INTEGER),R}, }},
    {{0,0},"NtWaitForMultipleObjects32", OK, RNTST, 5, {{1,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_READ}, {3,0,IB}, {4,sizeof(LARGE_INTEGER),R}, }},
    {{0,0},"NtWaitForSingleObject", OK, RNTST, 3, {{1,0,IB}, {2,sizeof(LARGE_INTEGER),R}, }},
    ...
    {{0,0},"NtAlpcCreatePort", OK|SYSINFO_CREATE_HANDLE, RNTST, 3, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {1,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, {2,sizeof(ALPC_PORT_ATTRIBUTES),R|CT,SYSARG_TYPE_ALPC_PORT_ATTRIBUTES}, }},
    {{0,0},"NtAlpcCreatePortSection", OK|SYSINFO_CREATE_HANDLE, RNTST, 6, {{4,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {5,sizeof(ULONG),W}, }},
    {{0,0},"NtAlpcCreateResourceReserve", OK|SYSINFO_CREATE_HANDLE, RNTST, 4, {{3,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, }},
    ...
    {{0,0},"NtAlpcOpenSenderProcess", OK|SYSINFO_CREATE_HANDLE, RNTST, 6, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {2,sizeof(PORT_MESSAGE),R|CT,SYSARG_TYPE_PORT_MESSAGE}, {5,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, }},
    {{0,0},"NtAlpcOpenSenderThread", OK|SYSINFO_CREATE_HANDLE, RNTST, 6, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {2,sizeof(PORT_MESSAGE),R|CT,SYSARG_TYPE_PORT_MESSAGE}, {5,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, }},
    ...
    /* added in Windows 7 */
    {{0,0},"NtAllocateReserveObject", OK|SYSINFO_CREATE_HANDLE, RNTST, 3, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {1,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, }},
