...
static syscall_info_t syscall_ntdll_info[] = {
    ...
    {{0,0},"NtAcceptConnectPort", OK|SYSINFO_CREATE_HANDLE, 6, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {2,sizeof(PORT_MESSAGE),R|CT,SYSARG_TYPE_PORT_MESSAGE}, {3,0,IB}, {4,sizeof(PORT_VIEW),R|W}, {5,sizeof(REMOTE_PORT_VIEW),R|W}, }},
    {{0,0},"NtAccessCheck", OK, 8, {{0,sizeof(SECURITY_DESCRIPTOR),R|CT,SYSARG_TYPE_SECURITY_DESCRIPTOR}, {3,sizeof(GENERIC_MAPPING),R}, {4,sizeof(PRIVILEGE_SET),W}, {5,sizeof(ULONG),R}, {6,sizeof(ACCESS_MASK),W}, {7,sizeof(BOOLEAN),W}, }},
    {{0,0},"NtAccessCheckAndAuditAlarm", OK, 11, {{0,sizeof(UNICODE_STRING),R|CT,SYSARG_TYPE_UNICODE_STRING}, {2,sizeof(UNICODE_STRING),R|CT,SYSARG_TYPE_UNICODE_STRING}, {3,sizeof(UNICODE_STRING),R|CT,SYSARG_TYPE_UNICODE_STRING}, {4,sizeof(SECURITY_DESCRIPTOR),R|CT,SYSARG_TYPE_SECURITY_DESCRIPTOR}, {6,sizeof(GENERIC_MAPPING),R}, {7,0,IB}, {8,sizeof(ACCESS_MASK),W}, {9,sizeof(BOOLEAN),W}, {10,sizeof(BOOLEAN),W}, }},
    {{0,0},"NtAccessCheckByType", OK, 11, {{0,sizeof(SECURITY_DESCRIPTOR),R|CT,SYSARG_TYPE_SECURITY_DESCRIPTOR}, {1,sizeof(SID),R}, {4,sizeof(OBJECT_TYPE_LIST),R}, {6,sizeof(GENERIC_MAPPING),R}, {7,sizeof(PRIVILEGE_SET),R}, {8,sizeof(ULONG),R}, {9,sizeof(ACCESS_MASK),W}, {10,sizeof(ULONG),W}, }},
    {{0,0},"NtAccessCheckByTypeAndAuditAlarm", OK, 16, {{0,sizeof(UNICODE_STRING),R|CT,SYSARG_TYPE_UNICODE_STRING}, {2,sizeof(UNICODE_STRING),R|CT,SYSARG_TYPE_UNICODE_STRING}, {3,sizeof(UNICODE_STRING),R|CT,SYSARG_TYPE_UNICODE_STRING}, {4,sizeof(SECURITY_DESCRIPTOR),R|CT,SYSARG_TYPE_SECURITY_DESCRIPTOR}, {5,sizeof(SID),R}, {9,sizeof(OBJECT_TYPE_LIST),R}, {11,sizeof(GENERIC_MAPPING),R}, {12,0,IB}, {13,sizeof(ACCESS_MASK),W}, {14,sizeof(ULONG),W}, {15,sizeof(BOOLEAN),W}, }},
    {{0,0},"NtAccessCheckByTypeResultList", OK, 11, {{0,sizeof(SECURITY_DESCRIPTOR),R|CT,SYSARG_TYPE_SECURITY_DESCRIPTOR}, {1,sizeof(SID),R}, {4,sizeof(OBJECT_TYPE_LIST),R}, {6,sizeof(GENERIC_MAPPING),R}, {7,sizeof(PRIVILEGE_SET),R}, {8,sizeof(ULONG),R}, {9,sizeof(ACCESS_MASK),W}, {10,sizeof(ULONG),W}, }},
    {{0,0},"NtAccessCheckByTypeResultListAndAuditAlarm", OK, 16, {{0,sizeof(UNICODE_STRING),R|CT,SYSARG_TYPE_UNICODE_STRING}, {2,sizeof(UNICODE_STRING),R|CT,SYSARG_TYPE_UNICODE_STRING}, {3,sizeof(UNICODE_STRING),R|CT,SYSARG_TYPE_UNICODE_STRING}, {4,sizeof(SECURITY_DESCRIPTOR),R|CT,SYSARG_TYPE_SECURITY_DESCRIPTOR}, {5,sizeof(SID),R}, {9,sizeof(OBJECT_TYPE_LIST),R}, {11,sizeof(GENERIC_MAPPING),R}, {12,0,IB}, {13,sizeof(ACCESS_MASK),W}, {14,sizeof(ULONG),W}, {15,sizeof(ULONG),W}, }},
    {{0,0},"NtAccessCheckByTypeResultListAndAuditAlarmByHandle", OK, 17, {{0,sizeof(UNICODE_STRING),R|CT,SYSARG_TYPE_UNICODE_STRING}, {3,sizeof(UNICODE_STRING),R|CT,SYSARG_TYPE_UNICODE_STRING}, {4,sizeof(UNICODE_STRING),R|CT,SYSARG_TYPE_UNICODE_STRING}, {5,sizeof(SECURITY_DESCRIPTOR),R|CT,SYSARG_TYPE_SECURITY_DESCRIPTOR}, {6,sizeof(SID),R}, {10,sizeof(OBJECT_TYPE_LIST),R}, {12,sizeof(GENERIC_MAPPING),R}, {13,0,IB}, {14,sizeof(ACCESS_MASK),W}, {15,sizeof(ULONG),W}, {16,sizeof(ULONG),W}, }},
    {{0,0},"NtAddAtom", OK, 3, {{0,-1,R}, {2,sizeof(USHORT),W}, }},
    {{0,0},"NtAddBootEntry", OK, 2, {{0,sizeof(UNICODE_STRING),R|CT,SYSARG_TYPE_UNICODE_STRING}, {1,sizeof(UNICODE_STRING),R|CT,SYSARG_TYPE_UNICODE_STRING}, }},
    {{0,0},"NtAddDriverEntry", OK, 2, {{0,sizeof(UNICODE_STRING),R|CT,SYSARG_TYPE_UNICODE_STRING}, {1,sizeof(UNICODE_STRING),R|CT,SYSARG_TYPE_UNICODE_STRING}, }},
    {{0,0},"NtAdjustGroupsToken", OK, 6, {{1,0,IB}, {2,sizeof(TOKEN_GROUPS),R}, {4,-3,W}, {4,-5,WI}, {5,sizeof(ULONG),W}, }},
    {{0,0},"NtAdjustPrivilegesToken", OK, 6, {{1,0,IB}, {2,sizeof(TOKEN_PRIVILEGES),R}, {4,-3,W}, {4,-5,WI}, {5,sizeof(ULONG),W}, }},
    {{0,0},"NtAlertResumeThread", OK, 2, {{1,sizeof(ULONG),W}, }},
    {{0,0},"NtAlertThread", OK, 1, },
    {{0,0},"NtAllocateLocallyUniqueId", OK, 1, {{0,sizeof(LUID),W}, }},
    {{0,0},"NtAllocateUserPhysicalPages", OK, 3, {{1,sizeof(ULONG),R}, {2,sizeof(ULONG),W}, }},
    {{0,0},"NtAllocateUuids", OK, 4, {{0,sizeof(LARGE_INTEGER),W}, {1,sizeof(ULONG),W}, {2,sizeof(ULONG),W}, {3,sizeof(UCHAR),W}, }},
    {{0,0},"NtAllocateVirtualMemory", OK, 6, {{1,sizeof(PVOID),R|W}, {3,sizeof(ULONG),R|W}, }},
    {{0,0},"NtApphelpCacheControl", OK, 2, {{1,sizeof(UNICODE_STRING),R|CT,SYSARG_TYPE_UNICODE_STRING}, }},
    {{0,0},"NtAreMappedFilesTheSame", OK, 2, },
    {{0,0},"NtAssignProcessToJobObject", OK, 2, },
    {{0,0},"NtCallbackReturn", OK, 3, },
    {{0,0},"NtCancelDeviceWakeupRequest", OK, 1, },
    {{0,0},"NtCancelIoFile", OK, 2, {{1,sizeof(IO_STATUS_BLOCK),W}, }},
    {{0,0},"NtCancelTimer", OK, 2, {{1,sizeof(BOOLEAN),W}, }},
    {{0,0},"NtClearEvent", OK, 1, },
    {{0,0},"NtClose", OK|SYSINFO_DELETE_HANDLE, 1, {{0,}, }},
    {{0,0},"NtCloseObjectAuditAlarm", OK, 3, {{0,sizeof(UNICODE_STRING),R|CT,SYSARG_TYPE_UNICODE_STRING}, {2,0,IB}, }},
    {{0,0},"NtCompactKeys", OK, 2, },
    {{0,0},"NtCompareTokens", OK, 3, {{2,sizeof(BOOLEAN),W}, }},
    {{0,0},"NtCompleteConnectPort", OK, 1, },
    {{0,0},"NtCompressKey", OK, 1, },
     ...
     */
    {{0,0},"NtConnectPort", OK|SYSINFO_CREATE_HANDLE, 8, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {1,sizeof(UNICODE_STRING),R|CT,SYSARG_TYPE_UNICODE_STRING}, {2,sizeof(SECURITY_QUALITY_OF_SERVICE),R|CT,SYSARG_TYPE_SECURITY_QOS}, {3,sizeof(PORT_VIEW),R|W}, {4,sizeof(REMOTE_PORT_VIEW),W}, {5,sizeof(ULONG),W}, {6,-7,R|WI}, {7,sizeof(ULONG),R|W}, }},
    {{0,0},"NtContinue", OK, 2, {{0,sizeof(CONTEXT),R|CT,SYSARG_TYPE_CONTEXT}, {1,0,IB}, }},
    {{0,0},"NtCreateChannel", OK|SYSINFO_CREATE_HANDLE, 2, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {1,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, }},
    {{0,0},"NtCreateDebugObject", OK|SYSINFO_CREATE_HANDLE, 4, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {2,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, {3,0,IB}, }},
    {{0,0},"NtCreateDirectoryObject", OK|SYSINFO_CREATE_HANDLE, 3, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {2,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, }},
    {{0,0},"NtCreateEvent", OK|SYSINFO_CREATE_HANDLE, 5, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {2,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, {4,0,IB}, }},
    {{0,0},"NtCreateEventPair", OK|SYSINFO_CREATE_HANDLE, 3, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {2,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, }},
    {{0,0},"NtCreateFile", OK|SYSINFO_CREATE_HANDLE, 11, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {2,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, {3,sizeof(IO_STATUS_BLOCK),W}, {4,sizeof(LARGE_INTEGER),R}, }},
    {{0,0},"NtCreateIoCompletion", OK|SYSINFO_CREATE_HANDLE, 4, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {2,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, }},
    {{0,0},"NtCreateJobObject", OK|SYSINFO_CREATE_HANDLE, 3, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {2,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, }},
    {{0,0},"NtCreateJobSet", OK, 3, {{1,sizeof(JOB_SET_ARRAY),R}, }},
    {{0,0},"NtCreateKey", OK|SYSINFO_CREATE_HANDLE, 7, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {2,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, {4,sizeof(UNICODE_STRING),R|CT,SYSARG_TYPE_UNICODE_STRING}, {6,sizeof(ULONG),W}, }},
    {{0,0},"NtCreateKeyedEvent", OK|SYSINFO_CREATE_HANDLE, 4, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {2,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, }},
    {{0,0},"NtCreateMailslotFile", OK|SYSINFO_CREATE_HANDLE, 8, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {2,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, {3,sizeof(IO_STATUS_BLOCK),W}, {7,sizeof(LARGE_INTEGER),R}, }},
    {{0,0},"NtCreateMutant", OK|SYSINFO_CREATE_HANDLE, 4, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {2,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, {3,0,IB}, }},
    {{0,0},"NtCreateNamedPipeFile", OK|SYSINFO_CREATE_HANDLE, 14, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {2,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, {3,sizeof(IO_STATUS_BLOCK),W}, {7,0,IB}, {8,0,IB}, {9,0,IB}, {13,sizeof(LARGE_INTEGER),R}, }},
    {{0,0},"NtCreatePagingFile", OK, 4, {{0,sizeof(UNICODE_STRING),R|CT,SYSARG_TYPE_UNICODE_STRING}, {1,sizeof(ULARGE_INTEGER),R}, {2,sizeof(ULARGE_INTEGER),R}, }},
    {{0,0},"NtCreatePort", OK|SYSINFO_CREATE_HANDLE, 5, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {1,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, }},
    {{0,0},"NtCreateProcess", OK|SYSINFO_CREATE_HANDLE, 8, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {2,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, {4,0,IB}, }},
    {{0,0},"NtCreateProcessEx", OK|SYSINFO_CREATE_HANDLE, 9, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {2,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, }},
    {{0,0},"NtCreateProfile", OK|SYSINFO_CREATE_HANDLE, 9, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {5,sizeof(ULONG),R}, }},
    {{0,0},"NtCreateSection", OK|SYSINFO_CREATE_HANDLE, 7, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {2,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, {3,sizeof(LARGE_INTEGER),R}, }},
    {{0,0},"NtCreateSemaphore", OK|SYSINFO_CREATE_HANDLE, 5, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {2,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, }},
    {{0,0},"NtCreateSymbolicLinkObject", OK|SYSINFO_CREATE_HANDLE, 4, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {2,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, {3,sizeof(UNICODE_STRING),R|CT,SYSARG_TYPE_UNICODE_STRING}, }},
    {{0,0},"NtCreateThread", OK|SYSINFO_CREATE_HANDLE, 8, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {2,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, {4,sizeof(CLIENT_ID),W}, {5,sizeof(CONTEXT),R|CT,SYSARG_TYPE_CONTEXT}, {6,sizeof(USER_STACK),R}, {7,0,IB}, }, &sysnum_CreateThread},
    {{0,0},"NtCreateThreadEx", OK|SYSINFO_CREATE_HANDLE, 11, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {2,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, 6,0,IB /*rest handled manually*/, }, &sysnum_CreateThreadEx},
    {{0,0},"NtCreateTimer", OK|SYSINFO_CREATE_HANDLE, 4, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {2,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, }},
    {{0,0},"NtCreateTok|SYSINFO_CREATE_HANDLEen", OK, 13, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {2,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, {4,sizeof(LUID),R}, {5,sizeof(LARGE_INTEGER),R}, {6,sizeof(TOKEN_USER),R}, {7,sizeof(TOKEN_GROUPS),R}, {8,sizeof(TOKEN_PRIVILEGES),R}, {9,sizeof(TOKEN_OWNER),R}, {10,sizeof(TOKEN_PRIMARY_GROUP),R}, {11,sizeof(TOKEN_DEFAULT_DACL),R}, {12,sizeof(TOKEN_SOURCE),R}, }},
    {{0,0},"NtCreateUserProcess", OK|SYSINFO_CREATE_HANDLE, 11, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {1,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {4,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, {5,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, {7,0,IB}, {8,sizeof(RTL_USER_PROCESS_PARAMETERS),R}, /*XXX i#98: arg 9 is in/out but not completely known*/ 10,sizeof(create_proc_thread_info_t),R/*rest handled manually*/, }, &sysnum_CreateUserProcess},
    {{0,0},"NtCreateWaitablePort", OK|SYSINFO_CREATE_HANDLE, 5, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {1,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, }},
    {{0,0},"NtDebugActiveProcess", OK, 2, },
    {{0,0},"NtDebugContinue", OK, 3, {{1,sizeof(CLIENT_ID),R}, }},
    {{0,0},"NtDelayExecution", OK, 2, {{0,0,IB}, {1,sizeof(LARGE_INTEGER),R}, }},
    {{0,0},"NtDeleteAtom", OK, 1, },
    {{0,0},"NtDeleteBootEntry", OK, 2, {{0,sizeof(UNICODE_STRING),R|CT,SYSARG_TYPE_UNICODE_STRING}, {1,sizeof(UNICODE_STRING),R|CT,SYSARG_TYPE_UNICODE_STRING}, }},
    {{0,0},"NtDeleteDriverEntry", OK, 2, {{0,sizeof(UNICODE_STRING),R|CT,SYSARG_TYPE_UNICODE_STRING}, {1,sizeof(UNICODE_STRING),R|CT,SYSARG_TYPE_UNICODE_STRING}, }},
    {{0,0},"NtDeleteFile", OK, 1, {{0,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, }},
    {{0,0},"NtDeleteKey", OK, 1, },
    {{0,0},"NtDeleteObjectAuditAlarm", OK, 3, {{0,sizeof(UNICODE_STRING),R|CT,SYSARG_TYPE_UNICODE_STRING}, {2,0,IB}, }},
    {{0,0},"NtDeleteValueKey", OK, 2, {{1,sizeof(UNICODE_STRING),R|CT,SYSARG_TYPE_UNICODE_STRING}, }},
    {{0,0},"NtDeviceIoControlFile", UNKNOWN/*to do param cmp for unknown ioctl codes*/, 10, {{4,sizeof(IO_STATUS_BLOCK),W}, /*param6 handled manually*/ {8,-9,W}, }, &sysnum_DeviceIoControlFile},
    {{0,0},"NtDisplayString", OK, 1, {{0,sizeof(UNICODE_STRING),R|CT,SYSARG_TYPE_UNICODE_STRING}, }},
    {{0,0},"NtDuplicateObject", OK|SYSINFO_CREATE_HANDLE, 7, {{3,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, }},
    {{0,0},"NtDuplicateToken", OK|SYSINFO_CREATE_HANDLE, 6, {{2,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, {3,0,IB}, {5,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, }},
    {{0,0},"NtEnumerateBootEntries", UNKNOWN, 2, },
    {{0,0},"NtEnumerateDriverEntries", UNKNOWN, 2, },
    {{0,0},"NtEnumerateKey", OK, 6, {{3,-4,W}, {3,-5,WI}, {5,sizeof(ULONG),W}, }},
    {{0,0},"NtEnumerateSystemEnvironmentValuesEx", UNKNOWN, 3, },
    {{0,0},"NtEnumerateValueKey", OK, 6, {{3,-4,W}, {3,-5,WI}, {5,sizeof(ULONG),W}, }},
    {{0,0},"NtExtendSection", OK, 2, {{1,sizeof(LARGE_INTEGER),R}, }},
    {{0,0},"NtFilterToken", OK|SYSINFO_CREATE_HANDLE, 6, {{2,sizeof(TOKEN_GROUPS),R}, {3,sizeof(TOKEN_PRIVILEGES),R}, {4,sizeof(TOKEN_GROUPS),R}, {5,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, }},
    {{0,0},"NtFindAtom", OK, 3, {{0,-1,R}, {2,sizeof(USHORT),W}, }},
    {{0,0},"NtFlushBuffersFile", OK, 2, {{1,sizeof(IO_STATUS_BLOCK),W}, }},
    {{0,0},"NtFlushInstructionCache", OK, 3, },
    {{0,0},"NtFlushKey", OK, 1, },
    {{0,0},"NtFlushVirtualMemory", OK, 4, {{1,sizeof(PVOID),R|W}, {2,sizeof(ULONG),R|W}, {3,sizeof(IO_STATUS_BLOCK),W}, }},
    {{0,0},"NtFlushWriteBuffer", OK, 0, },
    {{0,0},"NtFreeUserPhysicalPages", OK, 3, {{1,sizeof(ULONG),R|W}, {2,sizeof(ULONG),R}, }},
    {{0,0},"NtFreeVirtualMemory", OK, 4, {{1,sizeof(PVOID),R|W}, {2,sizeof(ULONG),R|W}, }},
    {{0,0},"NtFsControlFile", OK, 10, {{4,sizeof(IO_STATUS_BLOCK),W}, {8,-9,W}, }},
    {{0,0},"NtGetContextThread", OK, 2, {{1,sizeof(CONTEXT),W|CT,SYSARG_TYPE_CONTEXT}, }},
    {{0,0},"NtGetCurrentProcessorNumber", OK, 1, },
    {{0,0},"NtGetDevicePowerState", OK, 2, {{1,sizeof(DEVICE_POWER_STATE),W}, }},
    {{0,0},"NtGetPlugPlayEvent", OK, 4, {{2,-3,W}, }},
    /* BufferEntries is #elements, not #bytes */
    {{0,0},"NtGetWriteWatch", OK, 7, {{4,-5,WI|SYSARG_SIZE_IN_ELEMENTS,sizeof(void*)}, {4,-5,WI|SYSARG_SIZE_IN_ELEMENTS,sizeof(void*)}, {5,sizeof(ULONG),R|W}, {6,sizeof(ULONG),W}, }},
    {{0,0},"NtImpersonateAnonymousToken", OK, 1, },
    {{0,0},"NtImpersonateClientOfPort", OK, 2, {{1,sizeof(PORT_MESSAGE),R|CT,SYSARG_TYPE_PORT_MESSAGE}, }},
    {{0,0},"NtImpersonateThread", OK, 3, {{2,sizeof(SECURITY_QUALITY_OF_SERVICE),R|CT,SYSARG_TYPE_SECURITY_QOS}, }},
    {{0,0},"NtInitializeRegistry", OK, 1, {{0,0,IB}, }},
    {{0,0},"NtInitiatePowerAction", OK, 4, {{3,0,IB}, }},
    {{0,0},"NtIsProcessInJob", OK, 2, },
    {{0,0},"NtIsSystemResumeAutomatic", OK, 0, },
    {{0,0},"NtListenChannel", OK, 2, {{1,sizeof(CHANNEL_MESSAGE),W}, }},
    {{0,0},"NtListenPort", OK, 2, {{1,sizeof(PORT_MESSAGE),W|CT,SYSARG_TYPE_PORT_MESSAGE}, }},
    {{0,0},"NtLoadDriver", OK, 1, {{0,sizeof(UNICODE_STRING),R|CT,SYSARG_TYPE_UNICODE_STRING}, }},
    {{0,0},"NtLoadKey2", OK, 3, {{0,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, {1,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, }},
    {{0,0},"NtLoadKey", OK, 2, {{0,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, {1,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, }},
    {{0,0},"NtLoadKeyEx", OK, 4, {{0,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, {1,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, }},
    {{0,0},"NtLockFile", OK, 10, {{4,sizeof(IO_STATUS_BLOCK),W}, {5,sizeof(ULARGE_INTEGER),R}, {6,sizeof(ULARGE_INTEGER),R}, {8,0,IB}, {9,0,IB}, }},
    {{0,0},"NtLockProductActivationKeys", OK, 2, {{0,sizeof(ULONG),W}, {1,sizeof(ULONG),W}, }},
    {{0,0},"NtLockRegistryKey", OK, 1, },
    {{0,0},"NtLockVirtualMemory", OK, 4, {{1,sizeof(PVOID),R|W}, {2,sizeof(ULONG),R|W}, }},
    {{0,0},"NtMakePermanentObject", OK, 1, },
    {{0,0},"NtMakeTemporaryObject", OK, 1, },
    {{0,0},"NtMapCMFModule", OK, 6, {/* XXX DRi#415 not all known */ {4,sizeof(PVOID),W}, {5,sizeof(ULONG),W}, }},
    {{0,0},"NtMapUserPhysicalPages", OK, 3, {{1,sizeof(ULONG),R}, {2,sizeof(ULONG),R}, }},
    {{0,0},"NtMapUserPhysicalPagesScatter", OK, 3, {{0,sizeof(PVOID),R}, {1,sizeof(ULONG),R}, {2,sizeof(ULONG),R}, }},
    {{0,0},"NtMapViewOfSection", OK, 10, {{2,sizeof(PVOID),R|W}, {5,sizeof(LARGE_INTEGER),R|W}, {6,sizeof(ULONG),R|W}, }},
    {{0,0},"NtModifyBootEntry", OK, 2, {{0,sizeof(UNICODE_STRING),R|CT,SYSARG_TYPE_UNICODE_STRING}, {1,sizeof(UNICODE_STRING),R|CT,SYSARG_TYPE_UNICODE_STRING}, }},
    {{0,0},"NtModifyDriverEntry", OK, 2, {{0,sizeof(UNICODE_STRING),R|CT,SYSARG_TYPE_UNICODE_STRING}, {1,sizeof(UNICODE_STRING),R|CT,SYSARG_TYPE_UNICODE_STRING}, }},
    {{0,0},"NtNotifyChangeDirectoryFile", OK, 9, {{4,sizeof(IO_STATUS_BLOCK),W}, {5,sizeof(FILE_NOTIFY_INFORMATION),W}, {8,0,IB}, }},
    {{0,0},"NtNotifyChangeKey", OK, 10, {{4,sizeof(IO_STATUS_BLOCK),W}, {6,0,IB}, {9,0,IB}, }},
    {{0,0},"NtNotifyChangeMultipleKeys", OK, 12, {{2,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, {6,sizeof(IO_STATUS_BLOCK),W}, {8,0,IB}, {11,0,IB}, }},
    {{0,0},"NtOpenChannel", OK|SYSINFO_CREATE_HANDLE, 2, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {1,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, }},
    {{0,0},"NtOpenDirectoryObject", OK|SYSINFO_CREATE_HANDLE, 3, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {2,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, }},
    {{0,0},"NtOpenEvent", OK|SYSINFO_CREATE_HANDLE, 3, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {2,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, }},
    {{0,0},"NtOpenEventPair", OK|SYSINFO_CREATE_HANDLE, 3, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {2,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, }},
    {{0,0},"NtOpenFile", OK|SYSINFO_CREATE_HANDLE, 6, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {2,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, {3,sizeof(IO_STATUS_BLOCK),W}, }},
    {{0,0},"NtOpenIoCompletion", OK|SYSINFO_CREATE_HANDLE, 3, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {2,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, }},
    {{0,0},"NtOpenJobObject", OK|SYSINFO_CREATE_HANDLE, 3, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {2,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, }},
    {{0,0},"NtOpenKey", OK|SYSINFO_CREATE_HANDLE, 3, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {2,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, }},
    {{0,0},"NtOpenKeyEx", OK|SYSINFO_CREATE_HANDLE, 4, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {2,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, }},
    {{0,0},"NtOpenKeyedEvent", OK|SYSINFO_CREATE_HANDLE, 3, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {2,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, }},
    {{0,0},"NtOpenMutant", OK|SYSINFO_CREATE_HANDLE, 3, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {2,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, }},
    {{0,0},"NtOpenObjectAuditAlarm", OK, 12, {{0,sizeof(UNICODE_STRING),R|CT,SYSARG_TYPE_UNICODE_STRING}, {1,sizeof(PVOID),R}, {2,sizeof(UNICODE_STRING),R|CT,SYSARG_TYPE_UNICODE_STRING}, {3,sizeof(UNICODE_STRING),R|CT,SYSARG_TYPE_UNICODE_STRING}, {4,sizeof(SECURITY_DESCRIPTOR),R|CT,SYSARG_TYPE_SECURITY_DESCRIPTOR}, {8,sizeof(PRIVILEGE_SET),R}, {9,0,IB}, {10,0,IB}, {11,sizeof(BOOLEAN),W}, }},
    {{0,0},"NtOpenProcess", OK|SYSINFO_CREATE_HANDLE, 4, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {2,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, {3,sizeof(CLIENT_ID),R}, }},
    {{0,0},"NtOpenProcessToken", OK|SYSINFO_CREATE_HANDLE, 3, {{2,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, }},
    {{0,0},"NtOpenProcessTokenEx", OK|SYSINFO_CREATE_HANDLE, 4, {{3,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, }},
    {{0,0},"NtOpenSection", OK|SYSINFO_CREATE_HANDLE, 3, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {2,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, }},
    {{0,0},"NtOpenSemaphore", OK|SYSINFO_CREATE_HANDLE, 3, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {2,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, }},
    {{0,0},"NtOpenSymbolicLinkObject", OK|SYSINFO_CREATE_HANDLE, 3, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {2,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, }},
    {{0,0},"NtOpenThread", OK|SYSINFO_CREATE_HANDLE, 4, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {2,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, {3,sizeof(CLIENT_ID),R}, }},
    {{0,0},"NtOpenThreadToken", OK|SYSINFO_CREATE_HANDLE, 4, {{2,0,IB}, {3,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, }},
    {{0,0},"NtOpenThreadTokenEx", OK|SYSINFO_CREATE_HANDLE, 5, {{2,0,IB}, {4,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, }},
    {{0,0},"NtOpenTimer", OK|SYSINFO_CREATE_HANDLE, 3, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {2,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, }},
    {{0,0},"NtPlugPlayControl", OK, 4, {{1,-2,W}, }},
    {{0,0},"NtPowerInformation", OK, 5, {{3,-4,W}, }},
    {{0,0},"NtPrivilegeCheck", OK, 3, {{1,sizeof(PRIVILEGE_SET),R}, {2,sizeof(BOOLEAN),W}, }},
    {{0,0},"NtPrivilegedServiceAuditAlarm", OK, 5, {{0,sizeof(UNICODE_STRING),R|CT,SYSARG_TYPE_UNICODE_STRING}, {1,sizeof(UNICODE_STRING),R|CT,SYSARG_TYPE_UNICODE_STRING}, {3,sizeof(PRIVILEGE_SET),R}, {4,0,IB}, }},
    {{0,0},"NtPrivilegeObjectAuditAlarm", OK, 6, {{0,sizeof(UNICODE_STRING),R|CT,SYSARG_TYPE_UNICODE_STRING}, {4,sizeof(PRIVILEGE_SET),R}, {5,0,IB}, }},
    {{0,0},"NtProtectVirtualMemory", OK, 5, {{1,sizeof(PVOID),R|W}, {2,sizeof(ULONG),R|W}, {4,sizeof(ULONG),W}, }},
    {{0,0},"NtPulseEvent", OK, 2, {{1,sizeof(ULONG),W}, }},
    {{0,0},"NtQueryAttributesFile", OK, 2, {{0,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, {1,sizeof(FILE_BASIC_INFORMATION),W}, }},
    {{0,0},"NtQueryBootEntryOrder", UNKNOWN, 2, },
    {{0,0},"NtQueryBootOptions", UNKNOWN, 2, },
    {{0,0},"NtQueryDebugFilterState", OK, 2, },
    {{0,0},"NtQueryDefaultLocale", OK, 2, {{0,0,IB}, {1,sizeof(LCID),W}, }},
    {{0,0},"NtQueryDefaultUILanguage", OK, 1, {{0,sizeof(LANGID),W}, }},
    {{0,0},"NtQueryDirectoryFile", OK, 11, {{4,sizeof(IO_STATUS_BLOCK),W}, {5,-6,W}, {8,0,IB}, {9,sizeof(UNICODE_STRING),R|CT,SYSARG_TYPE_UNICODE_STRING}, {10,0,IB}, }},
    {{0,0},"NtQueryDirectoryObject", OK, 7, {{1,-2,W}, {1,-6,WI}, {3,0,IB}, {4,0,IB}, {5,sizeof(ULONG),R|W}, {6,sizeof(ULONG),W}, }},
    {{0,0},"NtQueryDriverEntryOrder", UNKNOWN, 2, },
    {{0,0},"NtQueryEaFile", OK, 9, {{1,sizeof(IO_STATUS_BLOCK),W}, {2,sizeof(FILE_FULL_EA_INFORMATION),W}, {4,0,IB}, {5,sizeof(FILE_GET_EA_INFORMATION),R}, {7,sizeof(ULONG),R}, {8,0,IB}, }},
    {{0,0},"NtQueryEvent", OK|SYSINFO_RET_SMALL_WRITE_LAST, 5, {{2,-3,W}, {2,-4,WI}, {4,sizeof(ULONG),W}, }},
    {{0,0},"NtQueryFullAttributesFile", OK, 2, {{0,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, {1,sizeof(FILE_NETWORK_OPEN_INFORMATION),W}, }},
    {{0,0},"NtQueryInformationAtom", OK|SYSINFO_RET_SMALL_WRITE_LAST, 5, {{2,-3,W}, {2,-4,WI}, {4,sizeof(ULONG),W}, }},
    {{0,0},"NtQueryInformationFile", OK, 5, {{1,sizeof(IO_STATUS_BLOCK),W}, {2,-3,W}, }},
    {{0,0},"NtQueryInformationJobObject", OK|SYSINFO_RET_SMALL_WRITE_LAST, 5, {{2,-3,W}, {2,-4,WI}, {4,sizeof(ULONG),W}, }},
    {{0,0},"NtQueryInformationPort", OK|SYSINFO_RET_SMALL_WRITE_LAST, 5, {{2,-3,W}, {2,-4,WI}, {4,sizeof(ULONG),W}, }},
    {{0,0},"NtQueryInformationProcess", OK|SYSINFO_RET_SMALL_WRITE_LAST, 5, {{2,-3,W}, {2,-4,WI}, {4,sizeof(ULONG),W}, }},
    {{0,0},"NtQueryInformationThread", OK|SYSINFO_RET_SMALL_WRITE_LAST, 5, {{2,-3,W}, {2,-4,WI}, {4,sizeof(ULONG),W}, }},
    {{0,0},"NtQueryInformationToken", OK|SYSINFO_RET_SMALL_WRITE_LAST, 5, {{2,-3,W}, {2,-4,WI}, {4,sizeof(ULONG),W}, }},
    {{0,0},"NtQueryInstallUILanguage", OK, 1, {{0,sizeof(LANGID),W}, }},
    {{0,0},"NtQueryIntervalProfile", OK, 2, {{1,sizeof(ULONG),W}, }},
    {{0,0},"NtQueryIoCompletion", OK|SYSINFO_RET_SMALL_WRITE_LAST, 5, {{2,-3,W}, {2,-4,WI}, {4,sizeof(ULONG),W}, }},
    {{0,0},"NtQueryKey", OK|SYSINFO_RET_SMALL_WRITE_LAST, 5, {{2,-3,W}, {2,-4,WI}, {4,sizeof(ULONG),W}, }},
    {{0,0},"NtQueryMultipleValueKey", OK, 6, {{1,sizeof(KEY_VALUE_ENTRY),R|W}, {3,-4,WI}, {4,sizeof(ULONG),R|W}, {5,sizeof(ULONG),W}, }},
    {{0,0},"NtQueryMutant", OK|SYSINFO_RET_SMALL_WRITE_LAST, 5, {{2,-3,W}, {2,-4,WI}, {4,sizeof(ULONG),W}, }},
    {{0,0},"NtQueryObject", OK|SYSINFO_RET_SMALL_WRITE_LAST, 5, {{2,-3,W}, {2,-4,WI}, {4,sizeof(ULONG),W}, }},
    {{0,0},"NtQueryOleDirectoryFile", OK, 11, {{4,sizeof(IO_STATUS_BLOCK),W}, {5,-6,W}, {8,0,IB}, {9,sizeof(UNICODE_STRING),R|CT,SYSARG_TYPE_UNICODE_STRING}, {10,0,IB}, }},
    {{0,0},"NtQueryOpenSubKeys", OK, 2, {{0,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, {1,sizeof(ULONG),W}, }},
    {{0,0},"NtQueryOpenSubKeysEx", OK, 4, {{0,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, {2,sizeof(ULONG),W}, {3,sizeof(ULONG),W}, }},
    {{0,0},"NtQueryPerformanceCounter", OK, 2, {{0,sizeof(LARGE_INTEGER),W}, {1,sizeof(LARGE_INTEGER),W}, }},
    {{0,0},"NtQueryPortInformationProcess", OK, 1, },
    {{0,0},"NtQueryQuotaInformationFile", OK, 9, {{1,sizeof(IO_STATUS_BLOCK),W}, {2,sizeof(FILE_USER_QUOTA_INFORMATION),W}, {4,0,IB}, {5,sizeof(FILE_QUOTA_LIST_INFORMATION),R}, {7,sizeof(SID),R}, {8,0,IB}, }},
    {{0,0},"NtQuerySection", OK|SYSINFO_RET_SMALL_WRITE_LAST, 5, {{2,-3,W}, {2,-4,WI}, {4,sizeof(ULONG),W}, }},
    {{0,0},"NtQuerySecurityObject", OK|SYSINFO_RET_SMALL_WRITE_LAST, 5, {{2,-3,W}, {2,-4,WI}, {4,sizeof(ULONG),W}, }},
    {{0,0},"NtQuerySemaphore", OK|SYSINFO_RET_SMALL_WRITE_LAST, 5, {{2,-3,W}, {2,-4,WI}, {4,sizeof(ULONG),W}, }},
     ...
     */
    {{0,0},"NtQuerySymbolicLinkObject", OK, 3, {{1,sizeof(UNICODE_STRING),W|CT,SYSARG_TYPE_UNICODE_STRING}, {2,sizeof(ULONG),W}, }},
    {{0,0},"NtQuerySystemEnvironmentValue", OK|SYSINFO_RET_SMALL_WRITE_LAST, 4, {{0,sizeof(UNICODE_STRING),R|CT,SYSARG_TYPE_UNICODE_STRING}, {1,-2,W}, {1,-3,WI}, {3,sizeof(ULONG),W}, }},
    {{0,0},"NtQuerySystemEnvironmentValueEx", UNKNOWN, 5, },
    /* One info class reads data, which is special-cased */
    {{0,0},"NtQuerySystemInformation", OK|SYSINFO_RET_SMALL_WRITE_LAST, 4, {{1,-2,W}, {1,-3,WI}, {3,sizeof(ULONG),W}, }, &sysnum_QuerySystemInformation},
    {{0,0},"NtQuerySystemTime", OK, 1, {{0,sizeof(LARGE_INTEGER),W}, }},
    {{0,0},"NtQueryTimer", OK|SYSINFO_RET_SMALL_WRITE_LAST, 5, {{2,-3,W}, {2,-4,WI}, {4,sizeof(ULONG),W}, }},
    {{0,0},"NtQueryTimerResolution", OK, 3, {{0,sizeof(ULONG),W}, {1,sizeof(ULONG),W}, {2,sizeof(ULONG),W}, }},
    {{0,0},"NtQueryValueKey", OK, 6, {{1,sizeof(UNICODE_STRING),R|CT,SYSARG_TYPE_UNICODE_STRING}, {3,-4,W}, {3,-5,WI}, {5,sizeof(ULONG),W}, }},
    {{0,0},"NtQueryVirtualMemory", OK, 6, {{3,-4,W}, {3,-5,WI}, {5,sizeof(ULONG),W}, }},
    {{0,0},"NtQueryVolumeInformationFile", OK, 5, {{1,sizeof(IO_STATUS_BLOCK),W}, {2,-3,W}, }},
    {{0,0},"NtQueueApcThread", OK, 5, },
    {{0,0},"NtRaiseException", OK, 3, {{0,sizeof(EXCEPTION_RECORD),R|CT,SYSARG_TYPE_EXCEPTION_RECORD}, {1,sizeof(CONTEXT),R|CT,SYSARG_TYPE_CONTEXT}, {2,0,IB}, }},
    {{0,0},"NtRaiseHardError", OK, 6, {{3,sizeof(ULONG_PTR),R}, {5,sizeof(ULONG),W}, }},
    {{0,0},"NtReadFile", OK, 9, {{4,sizeof(IO_STATUS_BLOCK),W}, {5,-6,W}, {5,-4,(W|IO)}, {7,sizeof(LARGE_INTEGER),R}, {8,sizeof(ULONG),R}, }},
    {{0,0},"NtReadFileScatter", OK, 9, {{4,sizeof(IO_STATUS_BLOCK),W}, {5,sizeof(FILE_SEGMENT_ELEMENT),R}, {7,sizeof(LARGE_INTEGER),R}, {8,sizeof(ULONG),R}, }},
    {{0,0},"NtReadRequestData", OK, 6, {{1,sizeof(PORT_MESSAGE),R|CT,SYSARG_TYPE_PORT_MESSAGE}, {3,-4,W}, {3,-5,WI}, {5,sizeof(ULONG),W}, }},
    {{0,0},"NtReadVirtualMemory", OK, 5, {{2,-3,W}, {2,-4,WI}, {4,sizeof(ULONG),W}, }},
    {{0,0},"NtRegisterThreadTerminatePort", OK, 1, },
    {{0,0},"NtReleaseKeyedEvent", OK, 4, {{2,0,IB}, {3,sizeof(LARGE_INTEGER),R}, }},
    {{0,0},"NtReleaseMutant", OK, 2, {{1,sizeof(ULONG),W}, }},
    {{0,0},"NtReleaseSemaphore", OK, 3, {{2,sizeof(LONG),W}, }},
    {{0,0},"NtRemoveIoCompletion", OK, 5, {{1,sizeof(ULONG),W}, {2,sizeof(ULONG),W}, {3,sizeof(IO_STATUS_BLOCK),W}, {4,sizeof(LARGE_INTEGER),R}, }},
    {{0,0},"NtRemoveProcessDebug", OK, 2, },
    {{0,0},"NtRenameKey", OK, 2, {{1,sizeof(UNICODE_STRING),R|CT,SYSARG_TYPE_UNICODE_STRING}, }},
    {{0,0},"NtReplaceKey", OK, 3, {{0,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, {2,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, }},
    {{0,0},"NtReplyPort", OK, 2, {{1,sizeof(PORT_MESSAGE),R|CT,SYSARG_TYPE_PORT_MESSAGE}, }},
    {{0,0},"NtReplyWaitReceivePort", OK, 4, {{1,sizeof(ULONG),W}, {2,sizeof(PORT_MESSAGE),R|CT,SYSARG_TYPE_PORT_MESSAGE}, {3,sizeof(PORT_MESSAGE),W|CT,SYSARG_TYPE_PORT_MESSAGE}, }},
    {{0,0},"NtReplyWaitReceivePortEx", OK, 5, {{1,sizeof(PVOID),W}, {2,sizeof(PORT_MESSAGE),R|CT,SYSARG_TYPE_PORT_MESSAGE}, {3,sizeof(PORT_MESSAGE),W|CT,SYSARG_TYPE_PORT_MESSAGE}, {4,sizeof(LARGE_INTEGER),R}, }},
    {{0,0},"NtReplyWaitReplyPort", OK, 2, {{1,sizeof(PORT_MESSAGE),R|W|CT,SYSARG_TYPE_PORT_MESSAGE}, }},
    {{0,0},"NtReplyWaitSendChannel", OK, 3, {{2,sizeof(CHANNEL_MESSAGE),W}, }},
    {{0,0},"NtRequestDeviceWakeup", OK, 1, },
    {{0,0},"NtRequestPort", OK, 2, {{1,sizeof(PORT_MESSAGE),R|CT,SYSARG_TYPE_PORT_MESSAGE}, }},
#if 1
     ...
     */
    {{0,0},"NtRequestWaitReplyPort", OK, 3, {{1,8,R}, {2,sizeof(PORT_MESSAGE),W|CT,SYSARG_TYPE_PORT_MESSAGE}, }},
#else
    {{0,0},"NtRequestWaitReplyPort", OK, 3, {{1,sizeof(PORT_MESSAGE),R|CT,SYSARG_TYPE_PORT_MESSAGE}, {2,sizeof(PORT_MESSAGE),W|CT,SYSARG_TYPE_PORT_MESSAGE}, }},
#endif
    {{0,0},"NtRequestWakeupLatency", OK, 1, },
    {{0,0},"NtResetEvent", OK, 2, {{1,sizeof(ULONG),W}, }},
    {{0,0},"NtResetWriteWatch", OK, 3, },
    {{0,0},"NtRestoreKey", OK, 3, },
    {{0,0},"NtResumeProcess", OK, 1, },
    {{0,0},"NtResumeThread", OK, 2, {{1,sizeof(ULONG),W}, }},
    {{0,0},"NtSaveKey", OK, 2, },
    {{0,0},"NtSaveKeyEx", OK, 3, },
    {{0,0},"NtSaveMergedKeys", OK, 3, },
    {{0,0},"NtSecureConnectPort", OK|SYSINFO_CREATE_HANDLE, 9, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {1,sizeof(UNICODE_STRING),R|CT,SYSARG_TYPE_UNICODE_STRING}, {2,sizeof(SECURITY_QUALITY_OF_SERVICE),R|CT,SYSARG_TYPE_SECURITY_QOS}, {3,sizeof(PORT_VIEW),R|W}, {4,sizeof(SID),R}, {5,sizeof(REMOTE_PORT_VIEW),R|W}, {6,sizeof(ULONG),W}, {7,-8,R|WI}, {8,sizeof(ULONG),R|W}, }},
    {{0,0},"NtSendWaitReplyChannel", OK, 4, {{3,sizeof(CHANNEL_MESSAGE),W}, }},
    {{0,0},"NtSetBootEntryOrder", UNKNOWN, 2, },
    {{0,0},"NtSetBootOptions", OK, 2, {{0,sizeof(BOOT_OPTIONS),R}, }},
    {{0,0},"NtSetContextChannel", OK, 1, },
    {{0,0},"NtSetContextThread", OK, 2, {{1,sizeof(CONTEXT),R|CT,SYSARG_TYPE_CONTEXT}, }},
    {{0,0},"NtSetDebugFilterState", OK, 3, {{2,0,IB}, }},
    {{0,0},"NtSetDefaultHardErrorPort", OK, 1, },
    {{0,0},"NtSetDefaultLocale", OK, 2, {{0,0,IB}, }},
    {{0,0},"NtSetDefaultUILanguage", OK, 1, },
    {{0,0},"NtSetEaFile", OK, 4, {{1,sizeof(IO_STATUS_BLOCK),W}, {2,sizeof(FILE_FULL_EA_INFORMATION),R}, }},
    {{0,0},"NtSetEvent", OK, 2, {{1,sizeof(ULONG),W}, }},
    {{0,0},"NtSetEventBoostPriority", OK, 1, },
    {{0,0},"NtSetHighEventPair", OK, 1, },
    {{0,0},"NtSetHighWaitLowEventPair", OK, 1, },
    {{0,0},"NtSetHighWaitLowThread", OK, 0, },
    {{0,0},"NtSetInformationDebugObject", OK, 5, {{4,sizeof(ULONG),W}, }},
    {{0,0},"NtSetInformationFile", OK, 5, {{1,sizeof(IO_STATUS_BLOCK),W}, }},
    {{0,0},"NtSetInformationJobObject", OK, 4, },
    {{0,0},"NtSetInformationKey", OK, 4, },
    {{0,0},"NtSetInformationObject", OK, 4, },
    {{0,0},"NtSetInformationProcess", OK, 4, },
    {{0,0},"NtSetInformationThread", OK, 4, },
    {{0,0},"NtSetInformationToken", OK, 4, },
    {{0,0},"NtSetIntervalProfile", OK, 2, },
    {{0,0},"NtSetIoCompletion", OK, 5, },
    {{0,0},"NtSetLdtEntries", OK, 4, },
    {{0,0},"NtSetLowEventPair", OK, 1, },
    {{0,0},"NtSetLowWaitHighEventPair", OK, 1, },
    {{0,0},"NtSetLowWaitHighThread", OK, 0, },
    {{0,0},"NtSetQuotaInformationFile", OK, 4, {{1,sizeof(IO_STATUS_BLOCK),W}, {2,sizeof(FILE_USER_QUOTA_INFORMATION),R}, }},
    {{0,0},"NtSetSecurityObject", OK, 3, {{2,sizeof(SECURITY_DESCRIPTOR),R|CT,SYSARG_TYPE_SECURITY_DESCRIPTOR}, }},
    {{0,0},"NtSetSystemEnvironmentValue", OK, 2, {{0,sizeof(UNICODE_STRING),R|CT,SYSARG_TYPE_UNICODE_STRING}, {1,sizeof(UNICODE_STRING),R|CT,SYSARG_TYPE_UNICODE_STRING}, }},
    {{0,0},"NtSetSystemEnvironmentValueEx", OK, 2, {{0,sizeof(UNICODE_STRING),R|CT,SYSARG_TYPE_UNICODE_STRING}, {1,sizeof(GUID),R}, }},
    /* Some info classes write data as well, which is special-cased */
    {{0,0},"NtSetSystemInformation", OK, 3, {{1,-2,R}, }, &sysnum_SetSystemInformation},
    {{0,0},"NtSetSystemPowerState", OK, 3, },
    {{0,0},"NtSetSystemTime", OK, 2, {{0,sizeof(LARGE_INTEGER),R}, {1,sizeof(LARGE_INTEGER),W}, }},
    {{0,0},"NtSetThreadExecutionState", OK, 2, {{1,sizeof(EXECUTION_STATE),W}, }},
    {{0,0},"NtSetTimer", OK, 7, {{1,sizeof(LARGE_INTEGER),R}, {4,0,IB}, {6,sizeof(BOOLEAN),W}, }},
    {{0,0},"NtSetTimerResolution", OK, 3, {{1,0,IB}, {2,sizeof(ULONG),W}, }},
    {{0,0},"NtSetUuidSeed", OK, 1, {{0,sizeof(UCHAR),R}, }},
    {{0,0},"NtSetValueKey", OK, 6, {{1,sizeof(UNICODE_STRING),R|CT,SYSARG_TYPE_UNICODE_STRING}, }},
    {{0,0},"NtSetVolumeInformationFile", OK, 5, {{1,sizeof(IO_STATUS_BLOCK),W}, }},
    {{0,0},"NtShutdownSystem", OK, 1, },
    {{0,0},"NtSignalAndWaitForSingleObject", OK, 4, {{2,0,IB}, {3,sizeof(LARGE_INTEGER),R}, }},
    {{0,0},"NtStartProfile", OK, 1, },
    {{0,0},"NtStopProfile", OK, 1, },
    {{0,0},"NtSuspendProcess", OK, 1, },
    {{0,0},"NtSuspendThread", OK, 2, {{1,sizeof(ULONG),W}, }},
    {{0,0},"NtSystemDebugControl", OK, 6, {{3,-4,W}, {3,-5,WI}, {5,sizeof(ULONG),W}, }},
    {{0,0},"NtTerminateJobObject", OK, 2, },
    {{0,0},"NtTerminateProcess", OK, 2, {{0,}}, },
    {{0,0},"NtTerminateThread", OK, 2, },
    {{0,0},"NtTestAlert", OK, 0, },
     ...
     */
    {{0,0},"NtTraceEvent", OK, 4, {{3,sizeof(EVENT_TRACE_HEADER),W}, }},
    {{0,0},"NtTranslateFilePath", OK, 4, {{0,sizeof(FILE_PATH),R}, {2,sizeof(FILE_PATH),W}, }},
    {{0,0},"NtUnloadDriver", OK, 1, {{0,sizeof(UNICODE_STRING),R|CT,SYSARG_TYPE_UNICODE_STRING}, }},
    {{0,0},"NtUnloadKey2", OK, 2, {{0,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, {1,0,IB}, }},
    {{0,0},"NtUnloadKey", OK, 1, {{0,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, }},
    {{0,0},"NtUnloadKeyEx", OK, 2, {{0,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, }},
    {{0,0},"NtUnlockFile", OK, 5, {{1,sizeof(IO_STATUS_BLOCK),W}, {2,sizeof(ULARGE_INTEGER),R}, {3,sizeof(ULARGE_INTEGER),R}, }},
    {{0,0},"NtUnlockVirtualMemory", OK, 4, {{1,sizeof(PVOID),R|W}, {2,sizeof(ULONG),R|W}, }},
    {{0,0},"NtUnmapViewOfSection", OK, 2, },
    {{0,0},"NtVdmControl", OK, 2, },
    {{0,0},"NtW32Call", OK, 5, {{3,-4,WI/*FIXME: de-ref w/o corresponding R to check definedness: but not enough info to understand exactly what's going on here*/}, {4,sizeof(ULONG),W}, }},
    {{0,0},"NtWaitForDebugEvent", OK, 4, {{1,0,IB}, {2,sizeof(LARGE_INTEGER),R}, {3,sizeof(DBGUI_WAIT_STATE_CHANGE),W}, }},
    {{0,0},"NtWaitForKeyedEvent", OK, 4, {{2,0,IB}, {3,sizeof(LARGE_INTEGER),R}, }},
    {{0,0},"NtWaitForMultipleObjects", OK, 5, {{1,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_READ}, {3,0,IB}, {4,sizeof(LARGE_INTEGER),R}, }},
    {{0,0},"NtWaitForMultipleObjects32", OK, 5, {{1,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_READ}, {3,0,IB}, {4,sizeof(LARGE_INTEGER),R}, }},
    {{0,0},"NtWaitForSingleObject", OK, 3, {{1,0,IB}, {2,sizeof(LARGE_INTEGER),R}, }},
    {{0,0},"NtWaitHighEventPair", OK, 1, },
    {{0,0},"NtWaitLowEventPair", OK, 1, },
    {{0,0},"NtWriteFile", OK, 9, {{4,sizeof(IO_STATUS_BLOCK),W}, {7,sizeof(LARGE_INTEGER),R}, {8,sizeof(ULONG),R}, }},
    {{0,0},"NtWriteFileGather", OK, 9, {{4,sizeof(IO_STATUS_BLOCK),W}, {5,sizeof(FILE_SEGMENT_ELEMENT),R}, {7,sizeof(LARGE_INTEGER),R}, {8,sizeof(ULONG),R}, }},
    {{0,0},"NtWriteRequestData", OK, 6, {{1,sizeof(PORT_MESSAGE),R|CT,SYSARG_TYPE_PORT_MESSAGE}, {5,sizeof(ULONG),W}, }},
    {{0,0},"NtWriteVirtualMemory", OK, 5, {{4,sizeof(ULONG),W}, }},
    {{0,0},"NtYieldExecution", OK, 0, },

    /* added in Windows 2003 */
    {{0,0},"NtSetDriverEntryOrder", OK, 2, {{0,-1,R|SYSARG_SIZE_IN_ELEMENTS,sizeof(ULONG)}, }},

    /* added in Windows XP64 WOW64 */
    {{0,0},"NtWow64CsrClientConnectToServer", UNKNOWN, 5, },
    {{0,0},"NtWow64CsrNewThread", OK, 0, },
    {{0,0},"NtWow64CsrIdentifyAlertableThread", OK, 0, },
    {{0,0},"NtWow64CsrClientCallServer", UNKNOWN, 4, },
    {{0,0},"NtWow64CsrAllocateCaptureBuffer", OK, 2, },
    {{0,0},"NtWow64CsrFreeCaptureBuffer", OK, 1, },
    {{0,0},"NtWow64CsrAllocateMessagePointer", UNKNOWN, 3, },
    {{0,0},"NtWow64CsrCaptureMessageBuffer", UNKNOWN, 4, },
    {{0,0},"NtWow64CsrCaptureMessageString", UNKNOWN, 5, },
    {{0,0},"NtWow64CsrSetPriorityClass", OK, 2, {{1,sizeof(ULONG),R|W}, }},
    {{0,0},"NtWow64CsrGetProcessId", OK, 0, },
    {{0,0},"NtWow64DebuggerCall", OK, 5, },
    /* args seem to be identical to NtQuerySystemInformation */
    {{0,0},"NtWow64GetNativeSystemInformation", OK|SYSINFO_RET_SMALL_WRITE_LAST, 4, {{1,-2,W}, {1,-3,WI}, {3,sizeof(ULONG),W}, }},
    {{0,0},"NtWow64QueryInformationProcess64", OK|SYSINFO_RET_SMALL_WRITE_LAST, 5, {{2,-3,W}, {2,-4,WI}, {4,sizeof(ULONG),W}, }},
    {{0,0},"NtWow64ReadVirtualMemory64", UNKNOWN, 7, },
    {{0,0},"NtWow64QueryVirtualMemory64", UNKNOWN, 8, },

    /* added in Windows Vista SP0 */
    {{0,0},"NtAcquireCMFViewOwnership", UNKNOWN, 3, },
    {{0,0},"NtAlpcAcceptConnectPort", OK|SYSINFO_CREATE_HANDLE, 9, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {3,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, {4,sizeof(ALPC_PORT_ATTRIBUTES),R|CT,SYSARG_TYPE_ALPC_PORT_ATTRIBUTES}, {6,sizeof(PORT_MESSAGE),R|CT,SYSARG_TYPE_PORT_MESSAGE}, {7,sizeof(ALPC_MESSAGE_ATTRIBUTES),R|W}, {8,0,IB}, }},
    {{0,0},"NtAlpcCancelMessage", OK, 3, {{2,sizeof(ALPC_CONTEXT_ATTRIBUTES),R}, }},
    {{0,0},"NtAlpcConnectPort", OK|SYSINFO_CREATE_HANDLE, 11, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {1,sizeof(UNICODE_STRING),R|CT,SYSARG_TYPE_UNICODE_STRING}, {2,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, {3,sizeof(ALPC_PORT_ATTRIBUTES),R|CT,SYSARG_TYPE_ALPC_PORT_ATTRIBUTES}, {5,sizeof(SID),R}, {6,-7,WI}, {7,sizeof(ULONG),R|W}, {8,sizeof(ALPC_MESSAGE_ATTRIBUTES),R|W}, {9,sizeof(ALPC_MESSAGE_ATTRIBUTES),R|W}, {10,sizeof(LARGE_INTEGER),R}, }},
    {{0,0},"NtAlpcCreatePort", OK|SYSINFO_CREATE_HANDLE, 3, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {1,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, {2,sizeof(ALPC_PORT_ATTRIBUTES),R|CT,SYSARG_TYPE_ALPC_PORT_ATTRIBUTES}, }},
    {{0,0},"NtAlpcCreatePortSection", OK|SYSINFO_CREATE_HANDLE, 6, {{4,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {5,sizeof(ULONG),W}, }},
    {{0,0},"NtAlpcCreateResourceReserve", OK|SYSINFO_CREATE_HANDLE, 4, {{3,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, }},
    {{0,0},"NtAlpcCreateSectionView", OK, 3, {{2,sizeof(ALPC_DATA_VIEW),R|W}, }},
    {{0,0},"NtAlpcCreateSecurityContext", OK, 3, {{2,sizeof(ALPC_SECURITY_ATTRIBUTES),R|W|CT,SYSARG_TYPE_ALPC_SECURITY_ATTRIBUTES}, }},
    {{0,0},"NtAlpcDeletePortSection", OK, 3, },
    {{0,0},"NtAlpcDeleteResourceReserve", OK, 3, },
    /* XXX: ok for shadowing purposes, but we should look at tracking
     * the allocation once we understand NtAlpcCreateSectionView
     */
    {{0,0},"NtAlpcDeleteSectionView", OK, 3, },
    {{0,0},"NtAlpcDeleteSecurityContext", OK, 3, },
    {{0,0},"NtAlpcDisconnectPort", OK, 2, },
    {{0,0},"NtAlpcImpersonateClientOfPort", OK, 3, {{1,sizeof(PORT_MESSAGE), R|CT,SYSARG_TYPE_PORT_MESSAGE}, }},
    {{0,0},"NtAlpcOpenSenderProcess", OK|SYSINFO_CREATE_HANDLE, 6, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {2,sizeof(PORT_MESSAGE),R|CT,SYSARG_TYPE_PORT_MESSAGE}, {5,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, }},
    {{0,0},"NtAlpcOpenSenderThread", OK|SYSINFO_CREATE_HANDLE, 6, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {2,sizeof(PORT_MESSAGE),R|CT,SYSARG_TYPE_PORT_MESSAGE}, {5,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, }},
    {{0,0},"NtAlpcQueryInformation", OK, 5, {{2,-3,W}, {4,sizeof(ULONG),W}, }},
    {{0,0},"NtAlpcQueryInformationMessage", OK, 6, {{1,sizeof(PORT_MESSAGE),R|CT,SYSARG_TYPE_PORT_MESSAGE}, {3,-4,W}, {5,sizeof(ULONG),W}, }},
    {{0,0},"NtAlpcRevokeSecurityContext", OK, 3, },
    /* FIXME i#98:
     ...
     */
    {{0,0},"NtAlpcSendWaitReceivePort", UNKNOWN, 8, {{4,-5,WI}, {5,sizeof(ULONG),W}, {7,sizeof(LARGE_INTEGER),R}, }},
    {{0,0},"NtAlpcSetInformation", OK, 4, {{2,-3,R}, }},
    {{0,0},"NtCancelIoFileEx", UNKNOWN, 3, },
    {{0,0},"NtCancelSynchronousIoFile", UNKNOWN, 3, },
    {{0,0},"NtClearAllSavepointsTransaction", UNKNOWN, 1, },
    {{0,0},"NtClearSavepointTransaction", UNKNOWN, 2, },
    {{0,0},"NtCommitComplete", UNKNOWN, 2, },
    {{0,0},"NtCommitEnlistment", UNKNOWN, 2, },
    {{0,0},"NtCommitTransaction", UNKNOWN, 2, },
    {{0,0},"NtCreateEnlistment", UNKNOWN, 8, },
    {{0,0},"NtCreateKeyTransacted", UNKNOWN, 8, },
    {{0,0},"NtCreatePrivateNamespace", UNKNOWN, 4, },
    {{0,0},"NtCreateResourceManager", UNKNOWN, 7, },
    {{0,0},"NtCreateTransaction", UNKNOWN, 10, },
    {{0,0},"NtCreateTransactionManager", UNKNOWN, 6, },
    {{0,0},"NtCreateTransactionManager", UNKNOWN, 6, },
    {{0,0},"NtCreateWorkerFactory", UNKNOWN, 10, },
    {{0,0},"NtDeletePrivateNamespace", UNKNOWN, 1, },
    {{0,0},"NtEnumerateTransactionObject", UNKNOWN, 5, },
    {{0,0},"NtFlushInstallUILanguage", UNKNOWN, 2, },
    {{0,0},"NtFlushProcessWriteBuffers", OK, 0, },
    {{0,0},"NtFreezeRegistry", UNKNOWN, 1, },
    {{0,0},"NtFreezeTransactions", UNKNOWN, 2, },
    {{0,0},"NtGetMUIRegistryInfo", UNKNOWN, 3, },
    {{0,0},"NtGetNextProcess", UNKNOWN, 5, },
    {{0,0},"NtGetNextThread", UNKNOWN, 6, },
    {{0,0},"NtGetNlsSectionPtr", UNKNOWN, 5, },
    {{0,0},"NtGetNotificationResourceManager", UNKNOWN, 7, },
    {{0,0},"NtInitializeNlsFiles", UNKNOWN, 3, },
    {{0,0},"NtIsUILanguageComitted", UNKNOWN, 0, },
    {{0,0},"NtListTransactions", UNKNOWN, 3, },
    {{0,0},"NtMarshallTransaction", UNKNOWN, 6, },
    {{0,0},"NtOpenEnlistment", UNKNOWN, 5, },
    {{0,0},"NtOpenKeyTransacted", UNKNOWN, 4, },
    {{0,0},"NtOpenPrivateNamespace", UNKNOWN, 4, },
    {{0,0},"NtOpenResourceManager", UNKNOWN, 5, },
    {{0,0},"NtOpenSession", UNKNOWN, 3, },
    {{0,0},"NtOpenTransaction", UNKNOWN, 5, },
    {{0,0},"NtOpenTransactionManager", UNKNOWN, 6, },
    {{0,0},"NtOpenTransactionManager", UNKNOWN, 6, },
    {{0,0},"NtPrepareComplete", UNKNOWN, 2, },
    {{0,0},"NtPrepareEnlistment", UNKNOWN, 2, },
    {{0,0},"NtPrePrepareComplete", UNKNOWN, 2, },
    {{0,0},"NtPrePrepareEnlistment", UNKNOWN, 2, },
    {{0,0},"NtPropagationComplete", UNKNOWN, 4, },
    {{0,0},"NtPropagationFailed", UNKNOWN, 3, },
    {{0,0},"NtPullTransaction", UNKNOWN, 7, },
    {{0,0},"NtQueryInformationEnlistment", UNKNOWN, 5, },
    {{0,0},"NtQueryInformationResourceManager", UNKNOWN, 5, },
    {{0,0},"NtQueryInformationTransaction", UNKNOWN, 5, },
    {{0,0},"NtQueryInformationTransactionManager", UNKNOWN, 5, },
    {{0,0},"NtQueryInformationTransactionManager", UNKNOWN, 5, },
    {{0,0},"NtQueryInformationWorkerFactory", UNKNOWN, 5, },
    {{0,0},"NtQueryLicenseValue", UNKNOWN, 5, },
    {{0,0},"NtReadOnlyEnlistment", UNKNOWN, 2, },
    {{0,0},"NtRecoverEnlistment", UNKNOWN, 2, },
    {{0,0},"NtRecoverResourceManager", UNKNOWN, 1, },
    {{0,0},"NtRecoverTransactionManager", UNKNOWN, 1, },
    {{0,0},"NtRegisterProtocolAddressInformation", UNKNOWN, 5, },
    {{0,0},"NtReleaseCMFViewOwnership", UNKNOWN, 0, },
    {{0,0},"NtReleaseWorkerFactoryWorker", UNKNOWN, 1, },
    {{0,0},"NtRemoveIoCompletionEx", UNKNOWN, 6, },
    {{0,0},"NtRollbackComplete", UNKNOWN, 2, },
    {{0,0},"NtRollbackEnlistment", UNKNOWN, 2, },
    {{0,0},"NtRollbackSavepointTransaction", UNKNOWN, 2, },
    {{0,0},"NtRollbackTransaction", UNKNOWN, 2, },
    {{0,0},"NtRollforwardTransactionManager", UNKNOWN, 2, },
    {{0,0},"NtSavepointComplete", UNKNOWN, 2, },
    {{0,0},"NtSavepointTransaction", UNKNOWN, 3, },
    {{0,0},"NtSetDriverEntryOrder", UNKNOWN, 2, },
    {{0,0},"NtSetInformationEnlistment", UNKNOWN, 4, },
    {{0,0},"NtSetInformationResourceManager", UNKNOWN, 4, },
    {{0,0},"NtSetInformationTransaction", UNKNOWN, 4, },
    {{0,0},"NtSetInformationTransactionManager", UNKNOWN, 4, },
    {{0,0},"NtSetInformationTransactionManager", UNKNOWN, 4, },
    {{0,0},"NtSetInformationWorkerFactory", UNKNOWN, 4, },
    {{0,0},"NtSetSystemEnvironmentValueEx", UNKNOWN, 5, },
    {{0,0},"NtShutdownWorkerFactory", UNKNOWN, 2, },
    {{0,0},"NtSinglePhaseReject", UNKNOWN, 2, },
    {{0,0},"NtStartTm", UNKNOWN, 0, },
    {{0,0},"NtThawRegistry", UNKNOWN, 0, },
    {{0,0},"NtThawTransactions", UNKNOWN, 0, },
    {{0,0},"NtTraceControl", UNKNOWN, 6, },
    {{0,0},"NtWaitForWorkViaWorkerFactory", UNKNOWN, 2, },
    {{0,0},"NtWorkerFactoryWorkerReady", UNKNOWN, 1, },

    /* added in Windows Vista SP1 */
    {{0,0},"NtRenameTransactionManager", UNKNOWN, 2, },
    {{0,0},"NtReplacePartitionUnit", UNKNOWN, 3, },
    {{0,0},"NtWow64CsrVerifyRegion", OK, 2, },
    {{0,0},"NtWow64WriteVirtualMemory64", OK, 7, {{6,sizeof(ULONGLONG),W}, }},
    {{0,0},"NtWow64CallFunction64", OK, 7, {{3,-2,R}, {5,-4,W}, {6,sizeof(ULONG),W}, }},

    /* added in Windows 7 */
    {{0,0},"NtAllocateReserveObject", OK|SYSINFO_CREATE_HANDLE, 3, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|SYSARG_WRITE}, {1,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, }},
    {{0,0},"NtCreateProfileEx", UNKNOWN, 10, },
    {{0,0},"NtDisableLastKnownGood", UNKNOWN, 0, },
    {{0,0},"NtDrawText", UNKNOWN, 1, },
    {{0,0},"NtEnableLastKnownGood", UNKNOWN, 0, },
    {{0,0},"NtNotifyChangeSession", UNKNOWN, 8, },
    {{0,0},"NtOpenKeyTransactedEx", UNKNOWN, 5, },
    {{0,0},"NtQuerySecurityAttributesToken", UNKNOWN, 6, },
    {{0,0},"NtQuerySystemInformationEx", UNKNOWN, 6, },
    {{0,0},"NtQueueApcThreadEx", UNKNOWN, 6, },
    {{0,0},"NtSerializeBoot", UNKNOWN, 0, },
    {{0,0},"NtSetIoCompletionEx", UNKNOWN, 6, },
    {{0,0},"NtSetTimerEx", UNKNOWN, 4, },
    {{0,0},"NtUmsThreadYield", UNKNOWN, 1, },
    {{0,0},"NtWow64GetCurrentProcessorNumberEx", OK, 1, {{0,sizeof(PROCESSOR_NUMBER),W}, }},
    {{0,0},"NtWow64InterlockedPopEntrySList", OK, 1, {{0,sizeof(SLIST_HEADER),R|W}, }},
};
