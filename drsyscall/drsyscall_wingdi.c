...
syscall_info_t syscall_user32_info[] = {
    ...
    {{0,0},"NtUserBeginPaint", OK|SYSINFO_CREATE_HANDLE, DRSYS_TYPE_HANDLE, 2, {{1,sizeof(PAINTSTRUCT),W,}, }, },
    ...
    {{0,0},"NtUserBuildHwndList", OK, RNTST, 7, {{2,0,IB,}, {5,-6,WI|SYSARG_SIZE_IN_ELEMENTS,sizeof(HWND)}, {6,sizeof(ULONG),R|W,}, }},
    ...
    {{0,0},"NtUserConvertMemHandle", OK, SYSARG_TYPE_UINT32, 2, },
    {{0,0},"NtUserCopyAcceleratorTable", OK, SYSARG_TYPE_SINT32, 3, {{1,-2,W|SYSARG_SIZE_IN_ELEMENTS,sizeof(ACCEL)}, }},
    {{0,0},"NtUserCountClipboardFormats", OK, SYSARG_TYPE_UINT32, 0, },
    {{0,0},"NtUserCreateAcceleratorTable", OK|SYSINFO_CREATE_HANDLE, DRSYS_TYPE_HANDLE, 2, {{0,-1,R|SYSARG_SIZE_IN_ELEMENTS,sizeof(ACCEL)}, }},
    {{0,0},"NtUserCreateCaret", OK, SYSARG_TYPE_BOOL32, 4, },
    {{0,0},"NtUserCreateDesktop", OK|SYSINFO_CREATE_HANDLE, DRSYS_TYPE_HANDLE, 5, {{0,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, {1,sizeof(UNICODE_STRING),R|CT,SYSARG_TYPE_UNICODE_STRING}, {2,sizeof(DEVMODEW)/*really var-len*/,R|CT,SYSARG_TYPE_DEVMODEW}, }},
    {{0,0},"NtUserCreateInputContext", OK|SYSINFO_CREATE_HANDLE|SYSINFO_IMM32_DLL, SYSARG_TYPE_UINT32, 1, },
    {{0,0},"NtUserCreateLocalMemHandle", OK|SYSINFO_CREATE_HANDLE, SYSARG_TYPE_UINT32, 4, {{1,-2,W}, {3,sizeof(UINT),W}, }},
    {{0,0},"NtUserCreateWindowEx", OK|SYSINFO_CREATE_HANDLE, DRSYS_TYPE_HANDLE, 15, {{1,sizeof(LARGE_STRING),R|CT,SYSARG_TYPE_LARGE_STRING}, {2,sizeof(LARGE_STRING),R|CT,SYSARG_TYPE_LARGE_STRING}, {3,sizeof(LARGE_STRING),R|CT,SYSARG_TYPE_LARGE_STRING}, }},
    {{0,0},"NtUserCreateWindowStation", OK|SYSINFO_CREATE_HANDLE, DRSYS_TYPE_HANDLE, 7, {{0,sizeof(OBJECT_ATTRIBUTES),R|CT,SYSARG_TYPE_OBJECT_ATTRIBUTES}, }, &sysnum_UserCreateWindowStation},
    ...
    {{0,0},"NtUserDestroyAcceleratorTable", OK|SYSINFO_DELETE_HANDLE, SYSARG_TYPE_BOOL8, 1, },
    {{0,0},"NtUserDestroyCursor", OK|SYSINFO_DELETE_HANDLE, SYSARG_TYPE_BOOL32, 2, },
    {{0,0},"NtUserDestroyInputContext", OK|SYSINFO_DELETE_HANDLE|SYSINFO_IMM32_DLL, SYSARG_TYPE_UINT32, 1, },
    {{0,0},"NtUserDestroyMenu", OK|SYSINFO_DELETE_HANDLE, SYSARG_TYPE_BOOL32, 1, },
    {{0,0},"NtUserDestroyWindow", OK|SYSINFO_DELETE_HANDLE, SYSARG_TYPE_BOOL8, 1, },
    ...
    {{0,0},"NtUserEmptyClipboard", OK, SYSARG_TYPE_UINT32, 0, },
    ...
    {{0,0},"NtUserGetClipboardData", OK, DRSYS_TYPE_HANDLE, 2, {{1,12,W,}, }},
    ...
    {{0,0},"NtUserGetCursorFrameInfo", OK, SYSARG_TYPE_UINT32, 4, },
    {{0,0},"NtUserGetCursorInfo", OK, SYSARG_TYPE_BOOL32, 1, {{0,SYSARG_SIZE_IN_FIELD,W,offsetof(CURSORINFO,cbSize)}, }},
    {{0,0},"NtUserGetDC", OK|SYSINFO_CREATE_HANDLE, DRSYS_TYPE_HANDLE, 1, {{0,}}, },
    {{0,0},"NtUserGetDCEx", OK|SYSINFO_CREATE_HANDLE, DRSYS_TYPE_HANDLE, 3, {{0,}}, },
    ...
    {{0,0},"NtUserGetWindowDC", OK|SYSINFO_CREATE_HANDLE, DRSYS_TYPE_HANDLE, 1, {{0,}}, },
...
syscall_info_t syscall_usercall_info[] = {
    ...
    {{0,0},"NtUserCallOneParam.RELEASEDC", OK|SYSINFO_DELETE_HANDLE, DRSYS_TYPE_UNSIGNED_INT, 2, /*HDC*/{{0,}}, },
...
syscall_info_t syscall_gdi32_info[] = {
    ...
    {{0,0},"NtGdiCreatePaletteInternal", OK|SYSINFO_CREATE_HANDLE, DRSYS_TYPE_HANDLE, 2, {{0,},}/*too complex: special-cased*/, &sysnum_GdiCreatePaletteInternal},
    ...
    {{0,0},"NtGdiGetDCforBitmap", OK|SYSINFO_CREATE_HANDLE, DRSYS_TYPE_HANDLE, 1, {{0,}}, },
    ...
    {{0,0},"NtGdiDdCreateSurface", OK|SYSINFO_CREATE_HANDLE, SYSARG_TYPE_UINT32, 8, {{1,sizeof(HANDLE),SYSARG_IS_HANDLE|R,}, {2,sizeof(DDSURFACEDESC),R|W,}, {3,sizeof(DD_SURFACE_GLOBAL),R|W,}, {4,sizeof(DD_SURFACE_LOCAL),R|W,}, {5,sizeof(DD_SURFACE_MORE),R|W,}, {6,sizeof(DD_CREATESURFACEDATA),R|W,}, {7,sizeof(HANDLE),SYSARG_IS_HANDLE|W,}, }},
    ...
    {{0,0},"NtGdiDdGetDC", OK|SYSINFO_CREATE_HANDLE, DRSYS_TYPE_HANDLE, 2, {{1,sizeof(PALETTEENTRY),R,}, }, },
    ...
    {{0,0},"NtGdiDdReleaseDC", OK, SYSARG_TYPE_BOOL32, 1, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|R,}, }},
    ...
    {{0,0},"NtGdiDdCreateD3DBuffer", OK|SYSINFO_CREATE_HANDLE, SYSARG_TYPE_UINT32, 8, {{1,sizeof(HANDLE),SYSARG_IS_HANDLE|R|W,}, {2,sizeof(DDSURFACEDESC),R|W,}, {3,sizeof(DD_SURFACE_GLOBAL),R|W,}, {4,sizeof(DD_SURFACE_LOCAL),R|W,}, {5,sizeof(DD_SURFACE_MORE),R|W,}, {6,sizeof(DD_CREATESURFACEDATA),R|W,}, {7,sizeof(HANDLE),SYSARG_IS_HANDLE|R|W,}, }},
    ...
    {{0,0},"NtGdiDvpUpdateVideoPort", OK, SYSARG_TYPE_UINT32, 4, {{1,sizeof(HANDLE),SYSARG_IS_HANDLE|R,}, {2,sizeof(HANDLE),SYSARG_IS_HANDLE|R,}, {3,sizeof(DD_UPDATEVPORTDATA),R|W,}, }},
    {{0,0},"NtGdiDvpWaitForVideoPortSync", OK, SYSARG_TYPE_UINT32, 2, {{1,sizeof(DD_WAITFORVPORTSYNCDATA),R|W,}, }},
    {{0,0},"NtGdiDvpAcquireNotification", OK|SYSINFO_CREATE_HANDLE, SYSARG_TYPE_UINT32, 3, {{1,sizeof(HANDLE),SYSARG_IS_HANDLE|R|W,}, {2,sizeof(DDVIDEOPORTNOTIFY),R,}, }},
    ...
    {{0,0},"NtGdiCreateColorSpace", OK|SYSINFO_CREATE_HANDLE, DRSYS_TYPE_HANDLE, 1, {{0,sizeof(LOGCOLORSPACEEXW),R,}, }},
    {{0,0},"NtGdiDeleteColorSpace", OK, SYSARG_TYPE_BOOL32, 1, {{0,sizeof(HANDLE),SYSARG_IS_HANDLE|R,}, }},
    {{0,0},"NtGdiSetColorSpace", OK, SYSARG_TYPE_BOOL32, 2, },
    {{0,0},"NtGdiCreateColorTransform", OK|SYSINFO_CREATE_HANDLE, DRSYS_TYPE_HANDLE, 8, {{1,sizeof(LOGCOLORSPACEW),R,}, }},
    ...
    {{0,0},"NtGdiCreateMetafileDC", OK|SYSINFO_CREATE_HANDLE, DRSYS_TYPE_HANDLE, 1, {{0,}}, },
    {{0,0},"NtGdiMakeInfoDC", OK, SYSARG_TYPE_BOOL32, 2, },
    {{0,0},"NtGdiCreateClientObj", OK|SYSINFO_CREATE_HANDLE, DRSYS_TYPE_HANDLE, 1, },
    {{0,0},"NtGdiDeleteClientObj", OK, SYSARG_TYPE_BOOL32, 1, },
    {{0,0},"NtGdiGetBitmapBits", OK, SYSARG_TYPE_SINT32, 3, {{2,-1,W,}, }},
    {{0,0},"NtGdiDeleteObjectApp", OK|SYSINFO_DELETE_HANDLE, SYSARG_TYPE_BOOL32, 1, {{0,}}, },
    ...
    {{0,0},"NtGdiCreateCompatibleDC", OK|SYSINFO_CREATE_HANDLE, DRSYS_TYPE_HANDLE, 1, {{0,}}, },
    {{0,0},"NtGdiCreateDIBitmapInternal", OK|SYSINFO_CREATE_HANDLE, DRSYS_TYPE_HANDLE, 11, {{4,-8,R,}, {5,-7,R,}, }},
    {{0,0},"NtGdiCreateDIBSection", OK|SYSINFO_CREATE_HANDLE, DRSYS_TYPE_HANDLE, 9, {{3,-5,R,}, {8,sizeof(PVOID),W,}, }},
    {{0,0},"NtGdiCreateSolidBrush", OK|SYSINFO_CREATE_HANDLE, DRSYS_TYPE_HANDLE, 2, },
    {{0,0},"NtGdiCreateDIBBrush", OK|SYSINFO_CREATE_HANDLE, DRSYS_TYPE_HANDLE, 6, },
    {{0,0},"NtGdiCreatePatternBrushInternal", OK|SYSINFO_CREATE_HANDLE, DRSYS_TYPE_HANDLE, 3, },
    {{0,0},"NtGdiCreateHatchBrushInternal", OK|SYSINFO_CREATE_HANDLE, DRSYS_TYPE_HANDLE, 3, },
    {{0,0},"NtGdiExtCreatePen", OK, DRSYS_TYPE_HANDLE, 11, {{7,-6,R|SYSARG_SIZE_IN_ELEMENTS,sizeof(ULONG)}, }},
    {{0,0},"NtGdiCreateEllipticRgn", OK|SYSINFO_CREATE_HANDLE, DRSYS_TYPE_HANDLE, 4, },
    {{0,0},"NtGdiCreateRoundRectRgn", OK|SYSINFO_CREATE_HANDLE, DRSYS_TYPE_HANDLE, 6, },
    {{0,0},"NtGdiCreateServerMetaFile", OK|SYSINFO_CREATE_HANDLE, DRSYS_TYPE_HANDLE, 6, {{2,-1,R,}, }},
    ...
    {{0,0},"NtGdiOpenDCW", OK|SYSINFO_CREATE_HANDLE, DRSYS_TYPE_HANDLE, 7/*8 on Vista+*/, {{0,sizeof(UNICODE_STRING),R|CT,SYSARG_TYPE_UNICODE_STRING,}, {1,sizeof(DEVMODEW)/*really var-len*/,R|CT,SYSARG_TYPE_DEVMODEW}, {2,sizeof(UNICODE_STRING),R|CT,SYSARG_TYPE_UNICODE_STRING,}, /*arg added in middle in Vista so special-cased*/}, &sysnum_GdiOpenDCW},
    ...
    {{0,0},"NtGdiCreatePen", OK|SYSINFO_CREATE_HANDLE, DRSYS_TYPE_HANDLE, 4, {{0,},}},
    ...
    {{0,0},"NtGdiCreateRectRgn", OK|SYSINFO_CREATE_HANDLE, DRSYS_TYPE_HANDLE, 4, },
    ...
    {{0,0},"NtGdiCreateCompatibleBitmap", OK|SYSINFO_CREATE_HANDLE, DRSYS_TYPE_HANDLE, 3, {{0,}, }},
    {{0,0},"NtGdiCreateBitmapFromDxSurface", OK|SYSINFO_CREATE_HANDLE, DRSYS_TYPE_HANDLE, 5, },
    ...
    {{0,0},"NtGdiCreateBitmap", OK|SYSINFO_CREATE_HANDLE, DRSYS_TYPE_HANDLE, 5, {{4,sizeof(BYTE),R,}, }},
    {{0,0},"NtGdiCreateHalftonePalette", OK|SYSINFO_CREATE_HANDLE, DRSYS_TYPE_HANDLE, 1, },
    ...
    {{0,0},"NtGdiSetPUMPDOBJ", OK|SYSINFO_CREATE_HANDLE, SYSARG_TYPE_BOOL32, 4, {{2,sizeof(HUMPD),SYSARG_IS_HANDLE|R|W,}, {3,sizeof(BOOL),W,}, }},
    ...
    {{0,0},"NtGdiDdCreateFullscreenSprite", OK|SYSINFO_CREATE_HANDLE, RNTST, 4, {{2,sizeof(HANDLE),SYSARG_IS_HANDLE|W,}, {3,sizeof(HDC),W,}, }},
