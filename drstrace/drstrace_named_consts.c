 ...
 * from WinNT.h, WinBase.h, WinDef.h headers.
 */
...
/* FIXME i#1550: truncation of "__int64" to "int"
...
static const_values_t sublang_neutral[] = {
    {0x00, "SUBLANG_NEUTRAL"},
    {0x01, "SUBLANG_DEFAULT"},
    {0x02, "SUBLANG_SYS_DEFAULT"},
    {0x03, "SUBLANG_CUSTOM_DEFAULT"},
    {0x04, "SUBLANG_CUSTOM_UNSPECIFIED"},
    {0x05, "SUBLANG_UI_CUSTOM_DEFAULT"},
    {0},
};

static const_values_t sublang_afrikaans_south_africa[] = {
    {0x01, "SUBLANG_AFRIKAANS_SOUTH_AFRICA"},
    {0},
};

static const_values_t sublang_albanian_albania[] = {
    {0x01, "SUBLANG_ALBANIAN_ALBANIA"},
    {0},
};

static const_values_t sublang_alsatian_france[] = {
    {0x01, "SUBLANG_ALSATIAN_FRANCE"},
    {0},
};

static const_values_t sublang_amharic_ethiopia[] = {
    {0x01, "SUBLANG_AMHARIC_ETHIOPIA"},
    {0},
};
...
static const_values_t sublang_bengali_india[] = {
    {0x01, "SUBLANG_BENGALI_INDIA"},
    {0x02, "SUBLANG_BENGALI_BANGLADESH"},
    {0},
};

static const_values_t sublang_bosnian_bosnia_herzegovina_latin[] = {
    {0x05, "SUBLANG_BOSNIAN_BOSNIA_HERZEGOVINA_LATIN"},
    {0x08, "SUBLANG_BOSNIAN_BOSNIA_HERZEGOVINA_CYRILLIC"},
    {0},
};

static const_values_t sublang_breton_france[] = {
    {0x01, "SUBLANG_BRETON_FRANCE"},
    {0},
};

static const_values_t sublang_bulgarian_bulgaria[] = {
    {0x01, "SUBLANG_BULGARIAN_BULGARIA"},
    {0},
};

static const_values_t sublang_catalan_catalan[] = {
    {0x01, "SUBLANG_CATALAN_CATALAN"},
    {0},
};

static const_values_t sublang_chinese_traditional[] = {
    {0x01, "SUBLANG_CHINESE_TRADITIONAL"},
    {0x02, "SUBLANG_CHINESE_SIMPLIFIED"},
    {0x03, "SUBLANG_CHINESE_HONGKONG"},
    {0x04, "SUBLANG_CHINESE_SINGAPORE"},
    {0x05, "SUBLANG_CHINESE_MACAU"},
    {0},
};

static const_values_t sublang_corsican_france[] = {
    {0x01, "SUBLANG_CORSICAN_FRANCE"},
    {0},
};

static const_values_t sublang_czech_czech_republic[] = {
    {0x01, "SUBLANG_CZECH_CZECH_REPUBLIC"},
    {0},
};

static const_values_t sublang_croatian_croatia[] = {
    {0x01, "SUBLANG_CROATIAN_CROATIA"},
    {0},
};

static const_values_t sublang_croatian_bosnia_herzegovina_latin[] = {
    {0x04, "SUBLANG_CROATIAN_BOSNIA_HERZEGOVINA_LATIN"},
    {0},
};

static const_values_t sublang_danish_denmark[] = {
    {0x01, "SUBLANG_DANISH_DENMARK"},
    {0},
};

static const_values_t sublang_dari_afghanistan[] = {
    {0x01, "SUBLANG_DARI_AFGHANISTAN"},
    {0},
};

static const_values_t sublang_divehi_maldives[] = {
    {0x01, "SUBLANG_DIVEHI_MALDIVES"},
    {0},
};

static const_values_t sublang_dutch[] = {
    {0x01, "SUBLANG_DUTCH"},
    {0x02, "SUBLANG_DUTCH_BELGIAN"},
    {0},
};

static const_values_t sublang_english_us[] = {
    {0x01, "SUBLANG_ENGLISH_US"},
    {0x02, "SUBLANG_ENGLISH_UK"},
    {0x03, "SUBLANG_ENGLISH_AUS"},
    {0x04, "SUBLANG_ENGLISH_CAN"},
    {0x05, "SUBLANG_ENGLISH_NZ"},
    {0x06, "SUBLANG_ENGLISH_EIRE"},
    {0x07, "SUBLANG_ENGLISH_SOUTH_AFRICA"},
    {0x08, "SUBLANG_ENGLISH_JAMAICA"},
    {0x09, "SUBLANG_ENGLISH_CARIBBEAN"},
    {0x0a, "SUBLANG_ENGLISH_BELIZE"},
    {0x0b, "SUBLANG_ENGLISH_TRINIDAD"},
    {0x0c, "SUBLANG_ENGLISH_ZIMBABWE"},
    {0x0d, "SUBLANG_ENGLISH_PHILIPPINES"},
    {0x10, "SUBLANG_ENGLISH_INDIA"},
    {0x11, "SUBLANG_ENGLISH_MALAYSIA"},
    {0x12, "SUBLANG_ENGLISH_SINGAPORE"},
    {0},
};

static const_values_t sublang_estonian_estonia[] = {
    {0x01, "SUBLANG_ESTONIAN_ESTONIA"},
    {0},
};

static const_values_t sublang_faeroese_faroe_islands[] = {
    {0x01, "SUBLANG_FAEROESE_FAROE_ISLANDS"},
    {0},
};

static const_values_t sublang_filipino_philippines[] = {
    {0x01, "SUBLANG_FILIPINO_PHILIPPINES"},
    {0},
};

static const_values_t sublang_finnish_finland[] = {
    {0x01, "SUBLANG_FINNISH_FINLAND"},
    {0},
};
...
static const_values_t sublang_kyrgyz_kyrgyzstan[] = {
    {0x01, "SUBLANG_KYRGYZ_KYRGYZSTAN"},
    {0},
};

static const_values_t sublang_lao_lao[] = {
    {0x01, "SUBLANG_LAO_LAO"},
    {0},
};

static const_values_t sublang_latvian_latvia[] = {
    {0x01, "SUBLANG_LATVIAN_LATVIA"},
    {0},
};

static const_values_t sublang_lithuanian[] = {
    {0x01, "SUBLANG_LITHUANIAN"},
    {0x02, "SUBLANG_LOWER_SORBIAN_GERMANY"},
    {0},
};

static const_values_t sublang_luxembourgish_luxembourg[] = {
    {0x01, "SUBLANG_LUXEMBOURGISH_LUXEMBOURG"},
    {0},
};

static const_values_t sublang_macedonian_macedonia[] = {
    {0x01, "SUBLANG_MACEDONIAN_MACEDONIA"},
    {0},
};

static const_values_t sublang_malay_malaysia[] = {
    {0x01, "SUBLANG_MALAY_MALAYSIA"},
    {0x02, "SUBLANG_MALAY_BRUNEI_DARUSSALAM"},
    {0},
};

static const_values_t sublang_malayalam_india[] = {
    {0x01, "SUBLANG_MALAYALAM_INDIA"},
    {0},
};

static const_values_t sublang_maltese_malta[] = {
    {0x01, "SUBLANG_MALTESE_MALTA"},
    {0},
};

static const_values_t sublang_maori_new_zealand[] = {
    {0x01, "SUBLANG_MAORI_NEW_ZEALAND"},
    {0},
};

static const_values_t sublang_mapudungun_chile[] = {
    {0x01, "SUBLANG_MAPUDUNGUN_CHILE"},
    {0},
};

static const_values_t sublang_marathi_india[] = {
    {0x01, "SUBLANG_MARATHI_INDIA"},
    {0},
};

static const_values_t sublang_mohawk_mohawk[] = {
    {0x01, "SUBLANG_MOHAWK_MOHAWK"},
    {0},
};

static const_values_t sublang_mongolian_cyrillic_mongolia[] = {
    {0x01, "SUBLANG_MONGOLIAN_CYRILLIC_MONGOLIA"},
    {0x02, "SUBLANG_MONGOLIAN_PRC"},
    {0},
};

static const_values_t sublang_nepali_india[] = {
    {0x02, "SUBLANG_NEPALI_INDIA"},
    {0x01, "SUBLANG_NEPALI_NEPAL"},
    {0},
};

static const_values_t sublang_norwegian_bokmal[] = {
    {0x01, "SUBLANG_NORWEGIAN_BOKMAL"},
    {0x02, "SUBLANG_NORWEGIAN_NYNORSK"},
    {0},
};

static const_values_t sublang_occitan_france[] = {
    {0x01, "SUBLANG_OCCITAN_FRANCE"},
    {0},
};

static const_values_t sublang_oriya_india[] = {
    {0x01, "SUBLANG_ORIYA_INDIA"},
    {0},
};

static const_values_t sublang_pashto_afghanistan[] = {
    {0x01, "SUBLANG_PASHTO_AFGHANISTAN"},
    {0},
};

static const_values_t sublang_persian_iran[] = {
    {0x01, "SUBLANG_PERSIAN_IRAN"},
    {0},
};

static const_values_t sublang_polish_poland[] = {
    {0x01, "SUBLANG_POLISH_POLAND"},
    {0},
};

static const_values_t sublang_portuguese[] = {
    {0x02, "SUBLANG_PORTUGUESE"},
    {0x01, "SUBLANG_PORTUGUESE_BRAZILIAN"},
    {0},
};

static const_values_t sublang_punjabi_india[] = {
    {0x01, "SUBLANG_PUNJABI_INDIA"},
    {0},
};

static const_values_t sublang_quechua_bolivia[] = {
    {0x01, "SUBLANG_QUECHUA_BOLIVIA"},
    {0x02, "SUBLANG_QUECHUA_ECUADOR"},
    {0x03, "SUBLANG_QUECHUA_PERU"},
    {0},
};

static const_values_t sublang_romanian_romania[] = {
    {0x01, "SUBLANG_ROMANIAN_ROMANIA"},
    {0},
};

static const_values_t sublang_romansh_switzerland[] = {
    {0x01, "SUBLANG_ROMANSH_SWITZERLAND"},
    {0},
};

static const_values_t sublang_russian_russia[] = {
    {0x01, "SUBLANG_RUSSIAN_RUSSIA"},
    {0},
};

static const_values_t sublang_sami_northern_norway[] = {
    {0x01, "SUBLANG_SAMI_NORTHERN_NORWAY"},
    {0x02, "SUBLANG_SAMI_NORTHERN_SWEDEN"},
    {0x03, "SUBLANG_SAMI_NORTHERN_FINLAND"},
    {0x04, "SUBLANG_SAMI_LULE_NORWAY"},
    {0x05, "SUBLANG_SAMI_LULE_SWEDEN"},
    {0x06, "SUBLANG_SAMI_SOUTHERN_NORWAY"},
    {0x07, "SUBLANG_SAMI_SOUTHERN_SWEDEN"},
    {0x08, "SUBLANG_SAMI_SKOLT_FINLAND"},
    {0x09, "SUBLANG_SAMI_INARI_FINLAND"},
    {0},
};

static const_values_t sublang_sanskrit_india[] = {
    {0x01, "SUBLANG_SANSKRIT_INDIA"},
    {0},
};

static const_values_t sublang_scottish_gaelic[] = {
    {0x01, "SUBLANG_SCOTTISH_GAELIC"},
    {0},
};

static const_values_t sublang_serbian_croatia[] = {
    {0x01, "SUBLANG_SERBIAN_CROATIA"},
    {0x02, "SUBLANG_SERBIAN_LATIN"},
    {0x03, "SUBLANG_SERBIAN_CYRILLIC"},
    {0x06, "SUBLANG_SERBIAN_BOSNIA_HERZEGOVINA_LATIN"},
    {0x07, "SUBLANG_SERBIAN_BOSNIA_HERZEGOVINA_CYRILLIC"},
    {0x0b, "SUBLANG_SERBIAN_MONTENEGRO_LATIN"},
    {0x0c, "SUBLANG_SERBIAN_MONTENEGRO_CYRILLIC"},
    {0x09, "SUBLANG_SERBIAN_SERBIA_LATIN"},
    {0x0a, "SUBLANG_SERBIAN_SERBIA_CYRILLIC"},
    {0},
};

static const_values_t sublang_sindhi_india[] = {
    {0x01, "SUBLANG_SINDHI_INDIA"},
    {0x02, "SUBLANG_SINDHI_PAKISTAN"},
    {0},
};

static const_values_t sublang_sindhi_afghanistan[] = {
    {0x02, "SUBLANG_SINDHI_AFGHANISTAN"},
    {0},
};

static const_values_t sublang_sinhalese_sri_lanka[] = {
    {0x01, "SUBLANG_SINHALESE_SRI_LANKA"},
    {0},
};

static const_values_t sublang_sotho_northern_south_africa[] = {
    {0x01, "SUBLANG_SOTHO_NORTHERN_SOUTH_AFRICA"},
    {0},
};

static const_values_t sublang_slovak_slovakia[] = {
    {0x01, "SUBLANG_SLOVAK_SLOVAKIA"},
    {0},
};

static const_values_t sublang_slovenian_slovenia[] = {
    {0x01, "SUBLANG_SLOVENIAN_SLOVENIA"},
    {0},
};

static const_values_t sublang_spanish[] = {
    {0x01, "SUBLANG_SPANISH"},
    {0x02, "SUBLANG_SPANISH_MEXICAN"},
    {0x03, "SUBLANG_SPANISH_MODERN"},
    {0x04, "SUBLANG_SPANISH_GUATEMALA"},
    {0x05, "SUBLANG_SPANISH_COSTA_RICA"},
    {0x06, "SUBLANG_SPANISH_PANAMA"},
    {0x07, "SUBLANG_SPANISH_DOMINICAN_REPUBLIC"},
    {0x08, "SUBLANG_SPANISH_VENEZUELA"},
    {0x09, "SUBLANG_SPANISH_COLOMBIA"},
    {0x0a, "SUBLANG_SPANISH_PERU"},
    {0x0b, "SUBLANG_SPANISH_ARGENTINA"},
    {0x0c, "SUBLANG_SPANISH_ECUADOR"},
    {0x0d, "SUBLANG_SPANISH_CHILE"},
    {0x0e, "SUBLANG_SPANISH_URUGUAY"},
    {0x0f, "SUBLANG_SPANISH_PARAGUAY"},
    {0x10, "SUBLANG_SPANISH_BOLIVIA"},
    {0x11, "SUBLANG_SPANISH_EL_SALVADOR"},
    {0x12, "SUBLANG_SPANISH_HONDURAS"},
    {0x13, "SUBLANG_SPANISH_NICARAGUA"},
    {0x14, "SUBLANG_SPANISH_PUERTO_RICO"},
    {0x15, "SUBLANG_SPANISH_US"},
    {0},
};

static const_values_t sublang_swahili_kenya[] = {
    {0x01, "SUBLANG_SWAHILI_KENYA"},
    {0},
};

static const_values_t sublang_swedish[] = {
    {0x01, "SUBLANG_SWEDISH"},
    {0x02, "SUBLANG_SWEDISH_FINLAND"},
    {0},
};

static const_values_t sublang_syriac_syria[] = {
    {0x01, "SUBLANG_SYRIAC_SYRIA"},
    {0},
};

static const_values_t sublang_tajik_tajikistan[] = {
    {0x01, "SUBLANG_TAJIK_TAJIKISTAN"},
    {0},
};

static const_values_t sublang_tamazight_algeria_latin[] = {
    {0x02, "SUBLANG_TAMAZIGHT_ALGERIA_LATIN"},
    {0},
};

static const_values_t sublang_tamil_india[] = {
    {0x01, "SUBLANG_TAMIL_INDIA"},
    {0},
};

static const_values_t sublang_tatar_russia[] = {
    {0x01, "SUBLANG_TATAR_RUSSIA"},
    {0},
};

static const_values_t sublang_telugu_india[] = {
    {0x01, "SUBLANG_TELUGU_INDIA"},
    {0},
};

static const_values_t sublang_thai_thailand[] = {
    {0x01, "SUBLANG_THAI_THAILAND"},
    {0},
};

static const_values_t sublang_tibetan_prc[] = {
    {0x01, "SUBLANG_TIBETAN_PRC"},
    {0},
};

static const_values_t sublang_tigrigna_eritrea[] = {
    {0x02, "SUBLANG_TIGRIGNA_ERITREA"},
    {0},
};

static const_values_t sublang_tswana_south_africa[] = {
    {0x01, "SUBLANG_TSWANA_SOUTH_AFRICA"},
    {0},
};

static const_values_t sublang_turkish_turkey[] = {
    {0x01, "SUBLANG_TURKISH_TURKEY"},
    {0},
};

static const_values_t sublang_turkmen_turkmenistan[] = {
    {0x01, "SUBLANG_TURKMEN_TURKMENISTAN"},
    {0},
};

static const_values_t sublang_uighur_prc[] = {
    {0x01, "SUBLANG_UIGHUR_PRC"},
    {0},
};

static const_values_t sublang_ukrainian_ukraine[] = {
    {0x01, "SUBLANG_UKRAINIAN_UKRAINE"},
    {0},
};

static const_values_t sublang_upper_sorbian_germany[] = {
    {0x01, "SUBLANG_UPPER_SORBIAN_GERMANY"},
    {0},
};

static const_values_t sublang_urdu_pakistan[] = {
    {0x01, "SUBLANG_URDU_PAKISTAN"},
    {0x02, "SUBLANG_URDU_INDIA"},
    {0},
};

static const_values_t sublang_uzbek_latin[] = {
    {0x01, "SUBLANG_UZBEK_LATIN"},
    {0x02, "SUBLANG_UZBEK_CYRILLIC"},
    {0},
};

static const_values_t sublang_vietnamese_vietnam[] = {
    {0x01, "SUBLANG_VIETNAMESE_VIETNAM"},
    {0},
};

static const_values_t sublang_welsh_united_kingdom[] = {
    {0x01, "SUBLANG_WELSH_UNITED_KINGDOM"},
    {0},
};
...
static const_values_t sublang_xhosa_south_africa[] = {
    {0x01, "SUBLANG_XHOSA_SOUTH_AFRICA"},
    {0},
};

static const_values_t sublang_yakut_russia[] = {
    {0x01, "SUBLANG_YAKUT_RUSSIA"},
    {0},
};
...
static const_values_t sublang_zulu_south_africa[] = {
    {0x01, "SUBLANG_ZULU_SOUTH_AFRICA"},
    {0},
};

static const_values_t sort_default[] = {
    {0x0, "SORT_DEFAULT"},
    {0x1, "SORT_INVARIANT_MATH"},
    {0},
};

static const_values_t sort_japanese_xjis[] = {
    {0x0, "SORT_JAPANESE_XJIS"},
    {0x1, "SORT_JAPANESE_UNICODE"},
    {0x4, "SORT_JAPANESE_RADICALSTROKE"},
    {0},
};

static const_values_t sort_chinese_big5[] = {
    {0x0, "SORT_CHINESE_BIG5"},
    {0},
};

static const_values_t sort_chinese_prcp[] = {
    {0x0, "SORT_CHINESE_PRCP"},
    {0x1, "SORT_CHINESE_UNICODE"},
    {0x2, "SORT_CHINESE_PRC"},
    {0x3, "SORT_CHINESE_BOPOMOFO"},
    {0x4, "SORT_CHINESE_RADICALSTROKE"},
    {0},
};

static const_values_t sort_korean_ksc[] = {
    {0x0, "SORT_KOREAN_KSC"},
    {0x1, "SORT_KOREAN_UNICODE"},
    {0},
};
...
static const_values_t sort_hungarian_default[] = {
    {0x0, "SORT_HUNGARIAN_DEFAULT"},
    {0x1, "SORT_HUNGARIAN_TECHNICAL"},
    {0},
};

static const_values_t sort_georgian_traditional[] = {
    {0x0, "SORT_GEORGIAN_TRADITIONAL"},
    {0x1, "SORT_GEORGIAN_MODERN"},
    {0},
};
...
/* FIXME i#1550: resolve ifdef macros
...
static const_values_t context_amd64[] = {
    {0x100000, "CONTEXT_AMD64"},
        /* FIXME i#1550: resolve ifdef macros
    {(CONTEXT_AMD64|
          0x1L), "CONTEXT_CONTROL"},
    {(CONTEXT_AMD64|
          0x2L), "CONTEXT_INTEGER"},
    {(CONTEXT_AMD64|
          0x4L), "CONTEXT_SEGMENTS"},
    {(CONTEXT_AMD64|
          0x8L), "CONTEXT_FLOATING_POINT"},
    {(CONTEXT_AMD64|
          0x10L), "CONTEXT_DEBUG_REGISTERS"},*/
    {(CONTEXT_CONTROL|
          CONTEXT_INTEGER|
    ...
    {(CONTEXT_CONTROL|
          ...
          /* FIXME i#1550: resolve ifdef macros
      {(CONTEXT_AMD64|
          0x20L), "CONTEXT_XSTATE"},*/
    {0x8000000, "CONTEXT_EXCEPTION_ACTIVE"},
...
static const_values_t initial_mxcsr[] = {
    {0x1f80, "INITIAL_MXCSR"},
    {0x027f, "INITIAL_FPCSR"},
    {0},
};

static const_values_t runtime_function_indirect[] = {
    {0x1, "RUNTIME_FUNCTION_INDIRECT"},
    {0},
};
...
/* FIXME i#1550: resolve the same structures
static const_values_t pf_temporal_level_1[] = {
...
static const_values_t access_min_ms_ace_type[] = {
    {(0x0), "ACCESS_MIN_MS_ACE_TYPE"},
    {(0x0), "ACCESS_ALLOWED_ACE_TYPE"},
    {(0x1), "ACCESS_DENIED_ACE_TYPE"},
    {(0x2), "SYSTEM_AUDIT_ACE_TYPE"},
    {(0x3), "SYSTEM_ALARM_ACE_TYPE"},
    {(0x3), "ACCESS_MAX_MS_V2_ACE_TYPE"},
    {(0x4), "ACCESS_ALLOWED_COMPOUND_ACE_TYPE"},
    {(0x4), "ACCESS_MAX_MS_V3_ACE_TYPE"},
    {(0x5), "ACCESS_MIN_MS_OBJECT_ACE_TYPE"},
    {(0x5), "ACCESS_ALLOWED_OBJECT_ACE_TYPE"},
    {(0x6), "ACCESS_DENIED_OBJECT_ACE_TYPE"},
    {(0x7), "SYSTEM_AUDIT_OBJECT_ACE_TYPE"},
    {(0x8), "SYSTEM_ALARM_OBJECT_ACE_TYPE"},
    ...
    {(0xA), "ACCESS_DENIED_CALLBACK_ACE_TYPE"},
    {(0xB), "ACCESS_ALLOWED_CALLBACK_OBJECT_ACE_TYPE"},
    {(0xC), "ACCESS_DENIED_CALLBACK_OBJECT_ACE_TYPE"},
    {(0xD), "SYSTEM_AUDIT_CALLBACK_ACE_TYPE"},
    {(0xE), "SYSTEM_ALARM_CALLBACK_ACE_TYPE"},
    {(0xF), "SYSTEM_AUDIT_CALLBACK_OBJECT_ACE_TYPE"},
    {(0x10), "SYSTEM_ALARM_CALLBACK_OBJECT_ACE_TYPE"},
    {(0x11), "SYSTEM_MANDATORY_LABEL_ACE_TYPE"},
    {(0x11), "ACCESS_MAX_MS_V5_ACE_TYPE"},
    {0},
};
...
static const_values_t ace_object_type_present[] = {
    {0x1, "ACE_OBJECT_TYPE_PRESENT"},
    {0x2, "ACE_INHERITED_OBJECT_TYPE_PRESENT"},
    {0},
};
...
static const_values_t disable_max_privilege[] = {
    {0x1, "DISABLE_MAX_PRIVILEGE"},
    {0x2, "SANDBOX_INERT"},
    {0x4, "LUA_TOKEN"},
    {0x8, "WRITE_RESTRICTED"},
    {0},
};
...
static const_values_t thread_terminate[] = {
    ...
    {(STANDARD_RIGHTS_REQUIRED|
          SYNCHRONIZE|
          0x3FF), "THREAD_ALL_ACCESS"},
    {0},
};

static const_values_t job_object_assign_process[] = {
    {(0x0001), "JOB_OBJECT_ASSIGN_PROCESS"},
    {(0x0002), "JOB_OBJECT_SET_ATTRIBUTES"},
    {(0x0004), "JOB_OBJECT_QUERY"},
    {(0x0008), "JOB_OBJECT_TERMINATE"},
    {(0x0010), "JOB_OBJECT_SET_SECURITY_ATTRIBUTES"},
    {(STANDARD_RIGHTS_REQUIRED|
          SYNCHRONIZE|
          0x1F), "JOB_OBJECT_ALL_ACCESS"},
    {0},
};
...
static const_values_t session_query_access[] = {
    {0x0001, "SESSION_QUERY_ACCESS"},
    {0x0002, "SESSION_MODIFY_ACCESS"},
    {(STANDARD_RIGHTS_REQUIRED|
...
static const_values_t file_read_data[] = {
    ...
    {(0x0004), "FILE_CREATE_PIPE_INSTANCE"},
    {(0x0008), "FILE_READ_EA"},
...
static const_values_t io_completion_modify_state[] = {
    {0x0002, "IO_COMPLETION_MODIFY_STATE"},
    {(STANDARD_RIGHTS_REQUIRED|
          SYNCHRONIZE|
          0x3), "IO_COMPLETION_ALL_ACCESS"},
    {0},
};
...
static const_values_t power_setting_value_version[] = {
    {(0x1), "POWER_SETTING_VALUE_VERSION"},
    {0},
};
...
static const_values_t acpi_ppm_software_all[] = {
    {0xFC, "ACPI_PPM_SOFTWARE_ALL"},
    {0xFD, "ACPI_PPM_SOFTWARE_ANY"},
    {0xFE, "ACPI_PPM_HARDWARE_ALL"},
    {0},
};

static const_values_t ms_ppm_software_all[] = {
    {0x1, "MS_PPM_SOFTWARE_ALL"},
    {0},
};
...
static const_values_t processor_idlestate_policy_count[] = {
    {0x3, "PROCESSOR_IDLESTATE_POLICY_COUNT"},
    {0},
};
...
static const_values_t image_dos_signature[] = {
    {0x5A4D, "IMAGE_DOS_SIGNATURE"},
    {0x454E, "IMAGE_OS2_SIGNATURE"},
    {0x454C, "IMAGE_OS2_SIGNATURE_LE"},
    {0x454C, "IMAGE_VXD_SIGNATURE"},
...
/* FIXME i#1550: resolve ifdef macros
static const_values_t image_dos_signature[] = {
    {0x4D5A, "IMAGE_DOS_SIGNATURE"},
    {0x4E45, "IMAGE_OS2_SIGNATURE"},
    {0x4C45, "IMAGE_OS2_SIGNATURE_LE"},
...
static const_values_t image_sym_undefined[] = {
    ...
    {0xFEFF, "IMAGE_SYM_SECTION_MAX"},
    {MAXLONG, "IMAGE_SYM_SECTION_MAX_EX"},
    {0},
};

static const_values_t image_sym_type_null[] = {
    {0x0000, "IMAGE_SYM_TYPE_NULL"},
    {0x0001, "IMAGE_SYM_TYPE_VOID"},
    {0x0002, "IMAGE_SYM_TYPE_CHAR"},
    {0x0003, "IMAGE_SYM_TYPE_SHORT"},
    {0x0004, "IMAGE_SYM_TYPE_INT"},
    {0x0005, "IMAGE_SYM_TYPE_LONG"},
    {0x0006, "IMAGE_SYM_TYPE_FLOAT"},
    {0x0007, "IMAGE_SYM_TYPE_DOUBLE"},
    {0x0008, "IMAGE_SYM_TYPE_STRUCT"},
    {0x0009, "IMAGE_SYM_TYPE_UNION"},
    {0x000A, "IMAGE_SYM_TYPE_ENUM"},
    {0x000B, "IMAGE_SYM_TYPE_MOE"},
    {0x000C, "IMAGE_SYM_TYPE_BYTE"},
    {0x000D, "IMAGE_SYM_TYPE_WORD"},
    {0x000E, "IMAGE_SYM_TYPE_UINT"},
    {0x000F, "IMAGE_SYM_TYPE_DWORD"},
    {0x8000, "IMAGE_SYM_TYPE_PCODE"},
    {0},
};
...
static const_values_t image_sym_class_null[] = {
    {0x0000, "IMAGE_SYM_CLASS_NULL"},
    {0x0001, "IMAGE_SYM_CLASS_AUTOMATIC"},
    {0x0002, "IMAGE_SYM_CLASS_EXTERNAL"},
    {0x0003, "IMAGE_SYM_CLASS_STATIC"},
    {0x0004, "IMAGE_SYM_CLASS_REGISTER"},
    {0x0005, "IMAGE_SYM_CLASS_EXTERNAL_DEF"},
    {0x0006, "IMAGE_SYM_CLASS_LABEL"},
    {0x0007, "IMAGE_SYM_CLASS_UNDEFINED_LABEL"},
    {0x0008, "IMAGE_SYM_CLASS_MEMBER_OF_STRUCT"},
    {0x0009, "IMAGE_SYM_CLASS_ARGUMENT"},
    {0x000A, "IMAGE_SYM_CLASS_STRUCT_TAG"},
    {0x000B, "IMAGE_SYM_CLASS_MEMBER_OF_UNION"},
    {0x000C, "IMAGE_SYM_CLASS_UNION_TAG"},
    {0x000D, "IMAGE_SYM_CLASS_TYPE_DEFINITION"},
    {0x000E, "IMAGE_SYM_CLASS_UNDEFINED_STATIC"},
    {0x000F, "IMAGE_SYM_CLASS_ENUM_TAG"},
    {0x0010, "IMAGE_SYM_CLASS_MEMBER_OF_ENUM"},
    {0x0011, "IMAGE_SYM_CLASS_REGISTER_PARAM"},
    {0x0012, "IMAGE_SYM_CLASS_BIT_FIELD"},
    {0x0044, "IMAGE_SYM_CLASS_FAR_EXTERNAL"},
    {0x0064, "IMAGE_SYM_CLASS_BLOCK"},
    {0x0065, "IMAGE_SYM_CLASS_FUNCTION"},
    {0x0066, "IMAGE_SYM_CLASS_END_OF_STRUCT"},
    {0x0067, "IMAGE_SYM_CLASS_FILE"},
    {0x0068, "IMAGE_SYM_CLASS_SECTION"},
    {0x0069, "IMAGE_SYM_CLASS_WEAK_EXTERNAL"},
    {0x006B, "IMAGE_SYM_CLASS_CLR_TOKEN"},
    {0},
};
...
static const_values_t image_rel_mips_absolute[] = {
    {0x0000, "IMAGE_REL_MIPS_ABSOLUTE"},
    {0x0001, "IMAGE_REL_MIPS_REFHALF"},
    {0x0002, "IMAGE_REL_MIPS_REFWORD"},
    {0x0003, "IMAGE_REL_MIPS_JMPADDR"},
    {0x0004, "IMAGE_REL_MIPS_REFHI"},
    {0x0005, "IMAGE_REL_MIPS_REFLO"},
    {0x0006, "IMAGE_REL_MIPS_GPREL"},
    {0x0007, "IMAGE_REL_MIPS_LITERAL"},
    {0x000A, "IMAGE_REL_MIPS_SECTION"},
    {0x000B, "IMAGE_REL_MIPS_SECREL"},
    {0x000C, "IMAGE_REL_MIPS_SECRELLO"},
    {0x000D, "IMAGE_REL_MIPS_SECRELHI"},
    {0x000E, "IMAGE_REL_MIPS_TOKEN"},
    {0x0010, "IMAGE_REL_MIPS_JMPADDR16"},
    {0x0022, "IMAGE_REL_MIPS_REFWORDNB"},
    {0x0025, "IMAGE_REL_MIPS_PAIR"},
    {0},
};

static const_values_t image_rel_alpha_absolute[] = {
    {0x0000, "IMAGE_REL_ALPHA_ABSOLUTE"},
    {0x0001, "IMAGE_REL_ALPHA_REFLONG"},
    {0x0002, "IMAGE_REL_ALPHA_REFQUAD"},
    {0x0003, "IMAGE_REL_ALPHA_GPREL32"},
    {0x0004, "IMAGE_REL_ALPHA_LITERAL"},
    {0x0005, "IMAGE_REL_ALPHA_LITUSE"},
    {0x0006, "IMAGE_REL_ALPHA_GPDISP"},
    {0x0007, "IMAGE_REL_ALPHA_BRADDR"},
    {0x0008, "IMAGE_REL_ALPHA_HINT"},
    {0x0009, "IMAGE_REL_ALPHA_INLINE_REFLONG"},
    {0x000A, "IMAGE_REL_ALPHA_REFHI"},
    {0x000B, "IMAGE_REL_ALPHA_REFLO"},
    {0x000C, "IMAGE_REL_ALPHA_PAIR"},
    {0x000D, "IMAGE_REL_ALPHA_MATCH"},
    {0x000E, "IMAGE_REL_ALPHA_SECTION"},
    {0x000F, "IMAGE_REL_ALPHA_SECREL"},
    {0x0010, "IMAGE_REL_ALPHA_REFLONGNB"},
    {0x0011, "IMAGE_REL_ALPHA_SECRELLO"},
    {0x0012, "IMAGE_REL_ALPHA_SECRELHI"},
    {0x0013, "IMAGE_REL_ALPHA_REFQ3"},
    {0x0014, "IMAGE_REL_ALPHA_REFQ2"},
    {0x0015, "IMAGE_REL_ALPHA_REFQ1"},
    {0x0016, "IMAGE_REL_ALPHA_GPRELLO"},
    {0x0017, "IMAGE_REL_ALPHA_GPRELHI"},
    {0},
};

static const_values_t image_rel_ppc_absolute[] = {
    {0x0000, "IMAGE_REL_PPC_ABSOLUTE"},
    {0x0001, "IMAGE_REL_PPC_ADDR64"},
    {0x0002, "IMAGE_REL_PPC_ADDR32"},
    {0x0003, "IMAGE_REL_PPC_ADDR24"},
    {0x0004, "IMAGE_REL_PPC_ADDR16"},
    {0x0005, "IMAGE_REL_PPC_ADDR14"},
    {0x0006, "IMAGE_REL_PPC_REL24"},
    {0x0007, "IMAGE_REL_PPC_REL14"},
    {0x0008, "IMAGE_REL_PPC_TOCREL16"},
    {0x0009, "IMAGE_REL_PPC_TOCREL14"},
    {0x000A, "IMAGE_REL_PPC_ADDR32NB"},
    {0x000B, "IMAGE_REL_PPC_SECREL"},
    {0x000C, "IMAGE_REL_PPC_SECTION"},
    {0x000D, "IMAGE_REL_PPC_IFGLUE"},
    {0x000E, "IMAGE_REL_PPC_IMGLUE"},
    {0x000F, "IMAGE_REL_PPC_SECREL16"},
    {0x0010, "IMAGE_REL_PPC_REFHI"},
    {0x0011, "IMAGE_REL_PPC_REFLO"},
    {0x0012, "IMAGE_REL_PPC_PAIR"},
    {0x0013, "IMAGE_REL_PPC_SECRELLO"},
    {0x0014, "IMAGE_REL_PPC_SECRELHI"},
    {0x0015, "IMAGE_REL_PPC_GPREL"},
    {0x0016, "IMAGE_REL_PPC_TOKEN"},
    {0x00FF, "IMAGE_REL_PPC_TYPEMASK"},
    {0x0100, "IMAGE_REL_PPC_NEG"},
    {0x0200, "IMAGE_REL_PPC_BRTAKEN"},
    {0x0400, "IMAGE_REL_PPC_BRNTAKEN"},
    {0x0800, "IMAGE_REL_PPC_TOCDEFN"},
    {0},
};

static const_values_t image_rel_sh3_absolute[] = {
    {0x0000, "IMAGE_REL_SH3_ABSOLUTE"},
    {0x0001, "IMAGE_REL_SH3_DIRECT16"},
    {0x0002, "IMAGE_REL_SH3_DIRECT32"},
    {0x0003, "IMAGE_REL_SH3_DIRECT8"},
    {0x0004, "IMAGE_REL_SH3_DIRECT8_WORD"},
    {0x0005, "IMAGE_REL_SH3_DIRECT8_LONG"},
    {0x0006, "IMAGE_REL_SH3_DIRECT4"},
    {0x0007, "IMAGE_REL_SH3_DIRECT4_WORD"},
    {0x0008, "IMAGE_REL_SH3_DIRECT4_LONG"},
    {0x0009, "IMAGE_REL_SH3_PCREL8_WORD"},
    {0x000A, "IMAGE_REL_SH3_PCREL8_LONG"},
    {0x000B, "IMAGE_REL_SH3_PCREL12_WORD"},
    {0x000C, "IMAGE_REL_SH3_STARTOF_SECTION"},
    {0x000D, "IMAGE_REL_SH3_SIZEOF_SECTION"},
    {0x000E, "IMAGE_REL_SH3_SECTION"},
    {0x000F, "IMAGE_REL_SH3_SECREL"},
    {0x0010, "IMAGE_REL_SH3_DIRECT32_NB"},
    {0x0011, "IMAGE_REL_SH3_GPREL4_LONG"},
    {0x0012, "IMAGE_REL_SH3_TOKEN"},
    {0x0013, "IMAGE_REL_SHM_PCRELPT"},
    {0x0014, "IMAGE_REL_SHM_REFLO"},
    {0x0015, "IMAGE_REL_SHM_REFHALF"},
    {0x0016, "IMAGE_REL_SHM_RELLO"},
    {0x0017, "IMAGE_REL_SHM_RELHALF"},
    {0x0018, "IMAGE_REL_SHM_PAIR"},
    {0x8000, "IMAGE_REL_SH_NOMODE"},
    {0},
};

static const_values_t image_rel_arm_absolute[] = {
    {0x0000, "IMAGE_REL_ARM_ABSOLUTE"},
    {0x0001, "IMAGE_REL_ARM_ADDR32"},
    {0x0002, "IMAGE_REL_ARM_ADDR32NB"},
    {0x0003, "IMAGE_REL_ARM_BRANCH24"},
    {0x0004, "IMAGE_REL_ARM_BRANCH11"},
    {0x0005, "IMAGE_REL_ARM_TOKEN"},
    {0x0006, "IMAGE_REL_ARM_GPREL12"},
    {0x0007, "IMAGE_REL_ARM_GPREL7"},
    {0x0008, "IMAGE_REL_ARM_BLX24"},
    {0x0009, "IMAGE_REL_ARM_BLX11"},
    {0x000E, "IMAGE_REL_ARM_SECTION"},
    {0x000F, "IMAGE_REL_ARM_SECREL"},
    {0},
};

static const_values_t image_rel_am_absolute[] = {
    {0x0000, "IMAGE_REL_AM_ABSOLUTE"},
    {0x0001, "IMAGE_REL_AM_ADDR32"},
    {0x0002, "IMAGE_REL_AM_ADDR32NB"},
    {0x0003, "IMAGE_REL_AM_CALL32"},
    {0x0004, "IMAGE_REL_AM_FUNCINFO"},
    {0x0005, "IMAGE_REL_AM_REL32_1"},
    {0x0006, "IMAGE_REL_AM_REL32_2"},
    {0x0007, "IMAGE_REL_AM_SECREL"},
    {0x0008, "IMAGE_REL_AM_SECTION"},
    {0x0009, "IMAGE_REL_AM_TOKEN"},
    {0},
};
...
static const_values_t image_rel_ia64_absolute[] = {
    {0x0000, "IMAGE_REL_IA64_ABSOLUTE"},
    {0x0001, "IMAGE_REL_IA64_IMM14"},
    {0x0002, "IMAGE_REL_IA64_IMM22"},
    {0x0003, "IMAGE_REL_IA64_IMM64"},
    {0x0004, "IMAGE_REL_IA64_DIR32"},
    {0x0005, "IMAGE_REL_IA64_DIR64"},
    {0x0006, "IMAGE_REL_IA64_PCREL21B"},
    {0x0007, "IMAGE_REL_IA64_PCREL21M"},
    {0x0008, "IMAGE_REL_IA64_PCREL21F"},
    {0x0009, "IMAGE_REL_IA64_GPREL22"},
    {0x000A, "IMAGE_REL_IA64_LTOFF22"},
    {0x000B, "IMAGE_REL_IA64_SECTION"},
    {0x000C, "IMAGE_REL_IA64_SECREL22"},
    {0x000D, "IMAGE_REL_IA64_SECREL64I"},
    {0x000E, "IMAGE_REL_IA64_SECREL32"},
    {0x0010, "IMAGE_REL_IA64_DIR32NB"},
    {0x0011, "IMAGE_REL_IA64_SREL14"},
    {0x0012, "IMAGE_REL_IA64_SREL22"},
    {0x0013, "IMAGE_REL_IA64_SREL32"},
    {0x0014, "IMAGE_REL_IA64_UREL32"},
    {0x0015, "IMAGE_REL_IA64_PCREL60X"},
    {0x0016, "IMAGE_REL_IA64_PCREL60B"},
    {0x0017, "IMAGE_REL_IA64_PCREL60F"},
    {0x0018, "IMAGE_REL_IA64_PCREL60I"},
    {0x0019, "IMAGE_REL_IA64_PCREL60M"},
    {0x001A, "IMAGE_REL_IA64_IMMGPREL64"},
    {0x001B, "IMAGE_REL_IA64_TOKEN"},
    {0x001C, "IMAGE_REL_IA64_GPREL32"},
    {0x001F, "IMAGE_REL_IA64_ADDEND"},
    {0},
};

static const_values_t image_rel_cef_absolute[] = {
    {0x0000, "IMAGE_REL_CEF_ABSOLUTE"},
    {0x0001, "IMAGE_REL_CEF_ADDR32"},
    {0x0002, "IMAGE_REL_CEF_ADDR64"},
    {0x0003, "IMAGE_REL_CEF_ADDR32NB"},
    {0x0004, "IMAGE_REL_CEF_SECTION"},
    {0x0005, "IMAGE_REL_CEF_SECREL"},
    {0x0006, "IMAGE_REL_CEF_TOKEN"},
    {0},
};

static const_values_t image_rel_cee_absolute[] = {
    {0x0000, "IMAGE_REL_CEE_ABSOLUTE"},
    {0x0001, "IMAGE_REL_CEE_ADDR32"},
    {0x0002, "IMAGE_REL_CEE_ADDR64"},
    {0x0003, "IMAGE_REL_CEE_ADDR32NB"},
    {0x0004, "IMAGE_REL_CEE_SECTION"},
    {0x0005, "IMAGE_REL_CEE_SECREL"},
    {0x0006, "IMAGE_REL_CEE_TOKEN"},
    {0},
};

static const_values_t image_rel_m32r_absolute[] = {
    {0x0000, "IMAGE_REL_M32R_ABSOLUTE"},
    {0x0001, "IMAGE_REL_M32R_ADDR32"},
    {0x0002, "IMAGE_REL_M32R_ADDR32NB"},
    {0x0003, "IMAGE_REL_M32R_ADDR24"},
    {0x0004, "IMAGE_REL_M32R_GPREL16"},
    {0x0005, "IMAGE_REL_M32R_PCREL24"},
    {0x0006, "IMAGE_REL_M32R_PCREL16"},
    {0x0007, "IMAGE_REL_M32R_PCREL8"},
    {0x0008, "IMAGE_REL_M32R_REFHALF"},
    {0x0009, "IMAGE_REL_M32R_REFHI"},
    {0x000A, "IMAGE_REL_M32R_REFLO"},
    {0x000B, "IMAGE_REL_M32R_PAIR"},
    {0x000C, "IMAGE_REL_M32R_SECTION"},
    {0x000D, "IMAGE_REL_M32R_SECREL32"},
    {0x000E, "IMAGE_REL_M32R_TOKEN"},
    {0},
};

static const_values_t image_rel_ebc_absolute[] = {
    {0x0000, "IMAGE_REL_EBC_ABSOLUTE"},
    {0x0001, "IMAGE_REL_EBC_ADDR32NB"},
    {0x0002, "IMAGE_REL_EBC_REL32"},
    {0x0003, "IMAGE_REL_EBC_SECTION"},
    {0x0004, "IMAGE_REL_EBC_SECREL"},
    {0},
};
...
static const_values_t is_text_unicode_ascii16[] = {
    {0x0001, "IS_TEXT_UNICODE_ASCII16"},
    {0x0010, "IS_TEXT_UNICODE_REVERSE_ASCII16"},
    {0x0002, "IS_TEXT_UNICODE_STATISTICS"},
    {0x0020, "IS_TEXT_UNICODE_REVERSE_STATISTICS"},
    {0x0004, "IS_TEXT_UNICODE_CONTROLS"},
    {0x0040, "IS_TEXT_UNICODE_REVERSE_CONTROLS"},
    {0x0008, "IS_TEXT_UNICODE_SIGNATURE"},
    {0x0080, "IS_TEXT_UNICODE_REVERSE_SIGNATURE"},
    {0x0100, "IS_TEXT_UNICODE_ILLEGAL_CHARS"},
    {0x0200, "IS_TEXT_UNICODE_ODD_LENGTH"},
    {0x0400, "IS_TEXT_UNICODE_DBCS_LEADBYTE"},
    {0x1000, "IS_TEXT_UNICODE_NULL_BYTES"},
    {0x000F, "IS_TEXT_UNICODE_UNICODE_MASK"},
    {0x00F0, "IS_TEXT_UNICODE_REVERSE_MASK"},
    {0x0F00, "IS_TEXT_UNICODE_NOT_UNICODE_MASK"},
    {0xF000, "IS_TEXT_UNICODE_NOT_ASCII_MASK"},
    {0},
};

static const_values_t compression_format_none[] = {
    {(0x0000), "COMPRESSION_FORMAT_NONE"},
    {(0x0001), "COMPRESSION_FORMAT_DEFAULT"},
    {(0x0002), "COMPRESSION_FORMAT_LZNT1"},
    {0},
};

static const_values_t compression_engine_standard[] = {
    {(0x0000), "COMPRESSION_ENGINE_STANDARD"},
    {(0x0100), "COMPRESSION_ENGINE_MAXIMUM"},
    {(0x0200), "COMPRESSION_ENGINE_HIBER"},
    {0},
};

static const_values_t sef_dacl_auto_inherit[] = {
    {0x01, "SEF_DACL_AUTO_INHERIT"},
    {0x02, "SEF_SACL_AUTO_INHERIT"},
    {0x04, "SEF_DEFAULT_DESCRIPTOR_FOR_OBJECT"},
    {0x08, "SEF_AVOID_PRIVILEGE_CHECK"},
    {0x10, "SEF_AVOID_OWNER_CHECK"},
    {0x20, "SEF_DEFAULT_OWNER_FROM_PARENT"},
    {0x40, "SEF_DEFAULT_GROUP_FROM_PARENT"},
    {0x100, "SEF_MACL_NO_WRITE_UP"},
    {0x200, "SEF_MACL_NO_READ_UP"},
    {0x400, "SEF_MACL_NO_EXECUTE_UP"},
    {0x1000, "SEF_AVOID_OWNER_RESTRICTION"},
...
static const_values_t message_resource_unicode[] = {
    {0x0001, "MESSAGE_RESOURCE_UNICODE"},
    {0},
};
...
static const_values_t ver_minorversion[] = {
    {0x0000001, "VER_MINORVERSION"},
    {0x0000002, "VER_MAJORVERSION"},
    {0x0000004, "VER_BUILDNUMBER"},
    {0x0000008, "VER_PLATFORMID"},
    {0x0000010, "VER_SERVICEPACKMINOR"},
    {0x0000020, "VER_SERVICEPACKMAJOR"},
    {0x0000040, "VER_SUITENAME"},
    {0x0000080, "VER_PRODUCT_TYPE"},
    {0},
};
...
static const_values_t rtl_condition_variable_init[] = {
    ...
    {0x1, "RTL_CONDITION_VARIABLE_LOCKMODE_SHARED"},
    {0},
};
...
static const_values_t eventlog_start_paired_event[] = {
    {0x0001, "EVENTLOG_START_PAIRED_EVENT"},
    {0x0002, "EVENTLOG_END_PAIRED_EVENT"},
    {0x0004, "EVENTLOG_END_ALL_PAIRED_EVENTS"},
    {0x0008, "EVENTLOG_PAIRED_EVENT_ACTIVE"},
    {0x0010, "EVENTLOG_PAIRED_EVENT_INACTIVE"},
    {0},
};
...
static const_values_t transactionmanager_query_information[] = {
    {(0x0001), "TRANSACTIONMANAGER_QUERY_INFORMATION"},
    {(0x0002), "TRANSACTIONMANAGER_SET_INFORMATION"},
    {(0x0004), "TRANSACTIONMANAGER_RECOVER"},
    {(0x0008), "TRANSACTIONMANAGER_RENAME"},
    {(0x0010), "TRANSACTIONMANAGER_CREATE_RM"},
    {(0x0020), "TRANSACTIONMANAGER_BIND_TRANSACTION"},
    {(STANDARD_RIGHTS_READ|
...
static const_values_t transaction_query_information[] = {
    {(0x0001), "TRANSACTION_QUERY_INFORMATION"},
    {(0x0002), "TRANSACTION_SET_INFORMATION"},
    {(0x0004), "TRANSACTION_ENLIST"},
    {(0x0008), "TRANSACTION_COMMIT"},
    {(0x0010), "TRANSACTION_ROLLBACK"},
    {(0x0020), "TRANSACTION_PROPAGATE"},
    {(0x0040), "TRANSACTION_RIGHT_RESERVED1"},
    {(STANDARD_RIGHTS_READ|
...
static const_values_t resourcemanager_query_information[] = {
    {(0x0001), "RESOURCEMANAGER_QUERY_INFORMATION"},
    {(0x0002), "RESOURCEMANAGER_SET_INFORMATION"},
    {(0x0004), "RESOURCEMANAGER_RECOVER"},
    {(0x0008), "RESOURCEMANAGER_ENLIST"},
    {(0x0010), "RESOURCEMANAGER_GET_NOTIFICATION"},
    {(0x0020), "RESOURCEMANAGER_REGISTER_PROTOCOL"},
    {(0x0040), "RESOURCEMANAGER_COMPLETE_PROPAGATION"},
    {(STANDARD_RIGHTS_READ|
...
static const_values_t enlistment_query_information[] = {
    {(0x0001), "ENLISTMENT_QUERY_INFORMATION"},
    {(0x0002), "ENLISTMENT_SET_INFORMATION"},
    {(0x0004), "ENLISTMENT_RECOVER"},
    {(0x0008), "ENLISTMENT_SUBORDINATE_RIGHTS"},
    {(0x0010), "ENLISTMENT_SUPERIOR_RIGHTS"},
    {(STANDARD_RIGHTS_READ|
...
static const_values_t fail_fast_generate_exception_address[] = {
    {0x1, "FAIL_FAST_GENERATE_EXCEPTION_ADDRESS"},
    {0x2, "FAIL_FAST_NO_HARD_ERROR_DLG"},
    {0},
};
...
static const_values_t pcf_dtrdsr[] = {
    {((DWORD)0x0001), "PCF_DTRDSR"},
    {((DWORD)0x0002), "PCF_RTSCTS"},
    {((DWORD)0x0004), "PCF_RLSD"},
    {((DWORD)0x0008), "PCF_PARITY_CHECK"},
    {((DWORD)0x0010), "PCF_XONXOFF"},
    {((DWORD)0x0020), "PCF_SETXCHAR"},
    {((DWORD)0x0040), "PCF_TOTALTIMEOUTS"},
    {((DWORD)0x0080), "PCF_INTTIMEOUTS"},
    {((DWORD)0x0100), "PCF_SPECIALCHARS"},
    {((DWORD)0x0200), "PCF_16BITMODE"},
    {0},
};

static const_values_t sp_parity[] = {
    {((DWORD)0x0001), "SP_PARITY"},
    {((DWORD)0x0002), "SP_BAUD"},
    {((DWORD)0x0004), "SP_DATABITS"},
    {((DWORD)0x0008), "SP_STOPBITS"},
    {((DWORD)0x0010), "SP_HANDSHAKING"},
    {((DWORD)0x0020), "SP_PARITY_CHECK"},
    {((DWORD)0x0040), "SP_RLSD"},
    {0},
};
...
static const_values_t databits_5[] = {
    {((WORD)0x0001), "DATABITS_5"},
    {((WORD)0x0002), "DATABITS_6"},
    {((WORD)0x0004), "DATABITS_7"},
    {((WORD)0x0008), "DATABITS_8"},
    {((WORD)0x0010), "DATABITS_16"},
    {((WORD)0x0020), "DATABITS_16X"},
    {0},
};

static const_values_t stopbits_10[] = {
    {((WORD)0x0001), "STOPBITS_10"},
    {((WORD)0x0002), "STOPBITS_15"},
    {((WORD)0x0004), "STOPBITS_20"},
    {0},
};

static const_values_t parity_none[] = {
    {((WORD)0x0100), "PARITY_NONE"},
    {((WORD)0x0200), "PARITY_ODD"},
    {((WORD)0x0400), "PARITY_EVEN"},
    {((WORD)0x0800), "PARITY_MARK"},
    {((WORD)0x1000), "PARITY_SPACE"},
    {0},
};
...
static const_values_t dtr_control_disable[] = {
    {0x00, "DTR_CONTROL_DISABLE"},
    {0x01, "DTR_CONTROL_ENABLE"},
    {0x02, "DTR_CONTROL_HANDSHAKE"},
    {0},
};

static const_values_t rts_control_disable[] = {
    {0x00, "RTS_CONTROL_DISABLE"},
    {0x01, "RTS_CONTROL_ENABLE"},
    {0x02, "RTS_CONTROL_HANDSHAKE"},
    {0x03, "RTS_CONTROL_TOGGLE"},
    {0},
};
...
static const_values_t gmem_fixed[] = {
    ...
    {0x0010, "GMEM_NOCOMPACT"},
    {0x0020, "GMEM_NODISCARD"},
    {0x0040, "GMEM_ZEROINIT"},
    {0x0080, "GMEM_MODIFY"},
    {0x0100, "GMEM_DISCARDABLE"},
    {0x1000, "GMEM_NOT_BANKED"},
    {0x2000, "GMEM_SHARE"},
    {0x2000, "GMEM_DDESHARE"},
    {0x4000, "GMEM_NOTIFY"},
    {GMEM_NOT_BANKED, "GMEM_LOWER"},
    {0x7F72, "GMEM_VALID_FLAGS"},
...
/* FIXME i#1550: Perhaps structure may be
 * included in previous */
static const_values_t gmem_discarded[] = {
    {0x4000, "GMEM_DISCARDED"},
    {0x00FF, "GMEM_LOCKCOUNT"},
    {0},
};

static const_values_t lmem_fixed[] = {
    {0x0000, "LMEM_FIXED"},
    {0x0002, "LMEM_MOVEABLE"},
    {0x0010, "LMEM_NOCOMPACT"},
    {0x0020, "LMEM_NODISCARD"},
    {0x0040, "LMEM_ZEROINIT"},
    {0x0080, "LMEM_MODIFY"},
    {0x0F00, "LMEM_DISCARDABLE"},
    {0x0F72, "LMEM_VALID_FLAGS"},
    {0x8000, "LMEM_INVALID_HANDLE"},
    {(LMEM_MOVEABLE|
          LMEM_ZEROINIT), "LHND"},
    {(LMEM_FIXED|
          LMEM_ZEROINIT), "LPTR"},
...
static const_values_t volume_name_dos[] = {
    {0x0, "VOLUME_NAME_DOS"},
    {0x1, "VOLUME_NAME_GUID"},
    {0x2, "VOLUME_NAME_NT"},
    {0x4, "VOLUME_NAME_NONE"},
    {0},
};
...
static const_values_t purge_txabort[] = {
    {0x0001, "PURGE_TXABORT"},
    {0x0002, "PURGE_RXABORT"},
    {0x0004, "PURGE_TXCLEAR"},
    {0x0008, "PURGE_RXCLEAR"},
    {0},
};
...
static const_values_t ms_cts_on[] = {
    {((DWORD)0x0010), "MS_CTS_ON"},
    {((DWORD)0x0020), "MS_DSR_ON"},
    {((DWORD)0x0040), "MS_RING_ON"},
    {((DWORD)0x0080), "MS_RLSD_ON"},
    {0},
};
...
static const_values_t process_heap_region[] = {
    {0x0001, "PROCESS_HEAP_REGION"},
    {0x0002, "PROCESS_HEAP_UNCOMMITTED_RANGE"},
    {0x0004, "PROCESS_HEAP_ENTRY_BUSY"},
    {0x0010, "PROCESS_HEAP_ENTRY_MOVEABLE"},
    {0x0020, "PROCESS_HEAP_ENTRY_DDESHARE"},
    {0},
};
...
static const_values_t sem_failcriticalerrors[] = {
    ...
    {0x0004, "SEM_NOALIGNMENTFAULTEXCEPT"},
...
static const_values_t proc_thread_attribute_number[] = {
    ...
    {ProcThreadAttributeValue(ProcThreadAttributeParentProcess,FALSE,TRUE,FALSE), "PROC_THREAD_ATTRIBUTE_PARENT_PROCESS"},
    {ProcThreadAttributeValue(ProcThreadAttributeExtendedFlags,FALSE,TRUE,TRUE), "PROC_THREAD_ATTRIBUTE_EXTENDED_FLAGS"},
    {ProcThreadAttributeValue(ProcThreadAttributeHandleList,FALSE,TRUE,FALSE), "PROC_THREAD_ATTRIBUTE_HANDLE_LIST"},
    {ProcThreadAttributeValue(ProcThreadAttributeGroupAffinity,TRUE,TRUE,FALSE), "PROC_THREAD_ATTRIBUTE_GROUP_AFFINITY"},
    {ProcThreadAttributeValue(ProcThreadAttributePreferredNode,FALSE,TRUE,FALSE), "PROC_THREAD_ATTRIBUTE_PREFERRED_NODE"},
    {ProcThreadAttributeValue(ProcThreadAttributeIdealProcessor,TRUE,TRUE,FALSE), "PROC_THREAD_ATTRIBUTE_IDEAL_PROCESSOR"},
    {ProcThreadAttributeValue(ProcThreadAttributeUmsThread,TRUE,TRUE,FALSE), "PROC_THREAD_ATTRIBUTE_UMS_THREAD"},
    {ProcThreadAttributeValue(ProcThreadAttributeMitigationPolicy,FALSE,TRUE,FALSE), "PROC_THREAD_ATTRIBUTE_MITIGATION_POLICY"},
    {0},
};

static const_values_t process_creation_mitigation_policy_dep_enable[] = {
    {0x01, "PROCESS_CREATION_MITIGATION_POLICY_DEP_ENABLE"},
    {0x02, "PROCESS_CREATION_MITIGATION_POLICY_DEP_ATL_THUNK_ENABLE"},
    {0x04, "PROCESS_CREATION_MITIGATION_POLICY_SEHOP_ENABLE"},
    {0},
};
...
static const_values_t resource_enum_ln[] = {
    {(0x0001), "RESOURCE_ENUM_LN"},
    {(0x0002), "RESOURCE_ENUM_MUI"},
    {(0x0004), "RESOURCE_ENUM_MUI_SYSTEM"},
    {(0x0008), "RESOURCE_ENUM_VALIDATE"},
    {(0x0010), "RESOURCE_ENUM_MODULE_EXACT"},
    {0},
};

static const_values_t base_search_path_flags[] = {
    {0x1, "BASE_SEARCH_PATH_ENABLE_SAFE_SEARCHMODE"},
    {0x10000, "BASE_SEARCH_PATH_DISABLE_SAFE_SEARCHMODE"},
    {0x8000, "BASE_SEARCH_PATH_PERMANENT"},
    {~0x18001, "BASE_SEARCH_PATH_INVALID_FLAGS"},
    {0},
};
...
static const_values_t dockinfo_undocked[] = {
    {(0x1), "DOCKINFO_UNDOCKED"},
    {(0x2), "DOCKINFO_DOCKED"},
    {(0x4), "DOCKINFO_USER_SUPPLIED"},
...
static const_values_t ac_line[] = {
    {0x00, "AC_LINE_OFFLINE"},
    {0x01, "AC_LINE_ONLINE"},
    {0x02, "AC_LINE_BACKUP_POWER"},
    {0xFF, "AC_LINE_UNKNOWN"},
    {0},
};

static const_values_t battery_flag[] = {
    {0x01, "BATTERY_FLAG_HIGH"},
    {0x02, "BATTERY_FLAG_LOW"},
    {0x04, "BATTERY_FLAG_CRITICAL"},
    {0x08, "BATTERY_FLAG_CHARGING"},
    {0x80, "BATTERY_FLAG_NO_BATTERY"},
    {0xFF, "BATTERY_FLAG_UNKNOWN"},
    {0},
};

static const_values_t battery_percentage_unknown[] = {
    {0xFF, "BATTERY_PERCENTAGE_UNKNOWN"},
